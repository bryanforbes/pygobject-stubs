...
RTSPConnectionAcceptCertificateFunc: TypeAlias = Callable[
    [Gio.TlsConnection, Gio.TlsCertificate, Gio.TlsCertificateFlags, Unpack[_DataTs]],
    bool,
]
...
def rtsp_connection_accept(
    socket: Gio.Socket, cancellable: Gio.Cancellable | None = ...
...
def rtsp_message_new_response(
    code: RTSPStatusCode, reason: str | None = ..., request: RTSPMessage | None = ...
) -> tuple[RTSPResult, RTSPMessage]: ...
...
class RTSPConnection(_gi.Struct):
    ...
    def do_tunnel(self, conn2: RTSPConnection | None = ...) -> RTSPResult: ...
    ...
    def set_accept_certificate_func(
        self,
        func: RTSPConnectionAcceptCertificateFunc[Unpack[_DataTs]],
    ...
    def set_tls_interaction(
        self, interaction: Gio.TlsInteraction | None = ...
    ) -> None: ...
...
class RTSPMessage(GObject.GBoxed):
    ...
    type: RTSPMsgType
    @property
    def hdr_fields(self) -> list[int | Any | None]: ...
    @property
    def body(self) -> int: ...
    @property
...
class RTSPWatchFuncs(_gi.Struct):
    ...
    def message_received(
        self,
    ) -> Callable[[RTSPWatch, RTSPMessage, Unpack[_DataTs]], RTSPResult]: ...
    @property
    def message_sent(
        self,
    ) -> Callable[[RTSPWatch, int, Unpack[_DataTs]], RTSPResult]: ...
    @property
    def closed(self) -> Callable[[RTSPWatch, Unpack[_DataTs]], RTSPResult]: ...
    @property
    def error(
        self,
    ) -> Callable[[RTSPWatch, RTSPResult, Unpack[_DataTs]], RTSPResult]: ...
    @property
    def tunnel_start(
        self,
    ) -> Callable[[RTSPWatch, Unpack[_DataTs]], RTSPStatusCode]: ...
    @property
    def tunnel_complete(self) -> Callable[[RTSPWatch, Unpack[_DataTs]], RTSPResult]: ...
    @property
    def error_full(
        self,
    ) -> Callable[
        [RTSPWatch, RTSPResult, RTSPMessage, int, Unpack[_DataTs]], RTSPResult
    ]: ...
    @property
    def tunnel_lost(self) -> Callable[[RTSPWatch, Unpack[_DataTs]], RTSPResult]: ...
    @property
    def tunnel_http_response(
        self,
    ) -> Callable[
        [RTSPWatch, RTSPMessage, RTSPMessage, Unpack[_DataTs]], RTSPResult
    ]: ...
