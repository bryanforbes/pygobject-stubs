...
ADDRESS_ANY_PORT = ...
ADDRESS_FAMILY: Final[str]
ADDRESS_NAME: Final[str]
ADDRESS_PHYSICAL: Final[str]
ADDRESS_PORT: Final[str]
ADDRESS_PROTOCOL: Final[str]
ADDRESS_SOCKADDR: Final[str]
AUTH_DOMAIN_ADD_PATH: Final[str]
AUTH_DOMAIN_BASIC_AUTH_CALLBACK: Final[str]
AUTH_DOMAIN_BASIC_AUTH_DATA: Final[str]
AUTH_DOMAIN_DIGEST_AUTH_CALLBACK: Final[str]
AUTH_DOMAIN_DIGEST_AUTH_DATA: Final[str]
AUTH_DOMAIN_FILTER: Final[str]
AUTH_DOMAIN_FILTER_DATA: Final[str]
AUTH_DOMAIN_GENERIC_AUTH_CALLBACK: Final[str]
AUTH_DOMAIN_GENERIC_AUTH_DATA: Final[str]
AUTH_DOMAIN_PROXY: Final[str]
AUTH_DOMAIN_REALM: Final[str]
AUTH_DOMAIN_REMOVE_PATH: Final[str]
AUTH_HOST: Final[str]
AUTH_IS_AUTHENTICATED: Final[str]
AUTH_IS_FOR_PROXY: Final[str]
AUTH_REALM: Final[str]
AUTH_SCHEME_NAME: Final[str]
CHAR_HTTP_CTL: Final[int]
CHAR_HTTP_SEPARATOR: Final[int]
CHAR_URI_GEN_DELIMS: Final[int]
CHAR_URI_PERCENT_ENCODED: Final[int]
CHAR_URI_SUB_DELIMS: Final[int]
COOKIE_JAR_ACCEPT_POLICY: Final[str]
COOKIE_JAR_DB_FILENAME: Final[str]
COOKIE_JAR_READ_ONLY: Final[str]
COOKIE_JAR_TEXT_FILENAME: Final[str]
COOKIE_MAX_AGE_ONE_DAY = ...
COOKIE_MAX_AGE_ONE_HOUR: Final[int]
COOKIE_MAX_AGE_ONE_WEEK = ...
COOKIE_MAX_AGE_ONE_YEAR = ...
FORM_MIME_TYPE_MULTIPART: Final[str]
FORM_MIME_TYPE_URLENCODED: Final[str]
HSTS_ENFORCER_DB_FILENAME: Final[str]
HSTS_POLICY_MAX_AGE_PAST = ...
LOGGER_LEVEL: Final[str]
LOGGER_MAX_BODY_SIZE: Final[str]
MAJOR_VERSION: Final[int]
MESSAGE_FIRST_PARTY: Final[str]
MESSAGE_FLAGS: Final[str]
MESSAGE_HTTP_VERSION: Final[str]
MESSAGE_IS_TOP_LEVEL_NAVIGATION: Final[str]
MESSAGE_METHOD: Final[str]
MESSAGE_PRIORITY: Final[str]
MESSAGE_REASON_PHRASE: Final[str]
MESSAGE_REQUEST_BODY: Final[str]
MESSAGE_REQUEST_BODY_DATA: Final[str]
MESSAGE_REQUEST_HEADERS: Final[str]
MESSAGE_RESPONSE_BODY: Final[str]
MESSAGE_RESPONSE_BODY_DATA: Final[str]
MESSAGE_RESPONSE_HEADERS: Final[str]
MESSAGE_SERVER_SIDE: Final[str]
MESSAGE_SITE_FOR_COOKIES: Final[str]
MESSAGE_STATUS_CODE: Final[str]
MESSAGE_TLS_CERTIFICATE: Final[str]
MESSAGE_TLS_ERRORS: Final[str]
MESSAGE_URI: Final[str]
MICRO_VERSION = ...
MINOR_VERSION: Final[int]
REQUEST_SESSION: Final[str]
REQUEST_URI: Final[str]
SERVER_ASYNC_CONTEXT: Final[str]
SERVER_HTTPS_ALIASES: Final[str]
SERVER_HTTP_ALIASES: Final[str]
SERVER_INTERFACE: Final[str]
SERVER_PORT: Final[str]
SERVER_RAW_PATHS: Final[str]
SERVER_SERVER_HEADER: Final[str]
SERVER_SSL_CERT_FILE: Final[str]
SERVER_SSL_KEY_FILE: Final[str]
SERVER_TLS_CERTIFICATE: Final[str]
SESSION_ACCEPT_LANGUAGE: Final[str]
SESSION_ACCEPT_LANGUAGE_AUTO: Final[str]
SESSION_ASYNC_CONTEXT: Final[str]
SESSION_HTTPS_ALIASES: Final[str]
SESSION_HTTP_ALIASES: Final[str]
SESSION_IDLE_TIMEOUT: Final[str]
SESSION_LOCAL_ADDRESS: Final[str]
SESSION_MAX_CONNS: Final[str]
SESSION_MAX_CONNS_PER_HOST: Final[str]
SESSION_PROXY_RESOLVER: Final[str]
SESSION_PROXY_URI: Final[str]
SESSION_SSL_CA_FILE: Final[str]
SESSION_SSL_STRICT: Final[str]
SESSION_SSL_USE_SYSTEM_CA_FILE: Final[str]
SESSION_TIMEOUT: Final[str]
SESSION_TLS_DATABASE: Final[str]
SESSION_TLS_INTERACTION: Final[str]
SESSION_USER_AGENT: Final[str]
SESSION_USE_NTLM: Final[str]
SESSION_USE_THREAD_CONTEXT: Final[str]
SOCKET_ASYNC_CONTEXT: Final[str]
SOCKET_FLAG_NONBLOCKING: Final[str]
SOCKET_IS_SERVER: Final[str]
SOCKET_LOCAL_ADDRESS: Final[str]
SOCKET_REMOTE_ADDRESS: Final[str]
SOCKET_SSL_CREDENTIALS: Final[str]
SOCKET_SSL_FALLBACK: Final[str]
SOCKET_SSL_STRICT: Final[str]
SOCKET_TIMEOUT: Final[str]
SOCKET_TLS_CERTIFICATE: Final[str]
SOCKET_TLS_ERRORS: Final[str]
SOCKET_TRUSTED_CERTIFICATE: Final[str]
SOCKET_USE_THREAD_CONTEXT: Final[str]
...
class Message(GObject.Object):
    ...
    request_body: MessageBody | None
    request_headers: MessageHeaders | None
    response_body: MessageBody | None
    response_headers: MessageHeaders | None
    status_code: int

    class Props(GObject.Object.Props):
        reason_phrase: str | None
        request_body: MessageBody | None
        request_body_data: GLib.Bytes | None
        request_headers: MessageHeaders | None
        response_body: MessageBody | None
        response_body_data: GLib.Bytes | None
        response_headers: MessageHeaders | None
        status_code: int
        uri: URI | None
...
class MessageHeaders:
    ...
    def set_content_type(
        self, content_type: str, params: dict[str, str] | None
    ) -> None: ...
...
class WebsocketConnection(GObject.Object):
    ...
    def close(self, code: WebsocketCloseCode, data: bytes | None) -> None: ...
    ...
    def send_binary(self, data: bytes | None) -> None: ...
    def send_message(*args, **kwargs): ...
