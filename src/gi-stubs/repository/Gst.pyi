...
class Iterator(GObject.GBoxed, Generic[T]):
    ...
    def free(self) -> None: ...
    @classmethod
    def new_single(cls, type: _type[Any], object: Any) -> Iterator: ...
...
class Query(MiniObjectMixin, GObject.GBoxed):
    ...
    def add_allocation_meta(
        self, api: _type[Any], params: Structure | None = None
    ) -> None: ...
    ...
    def find_allocation_meta(self, api: _type[Any]) -> tuple[bool, int]: ...
    ...
    def parse_nth_allocation_meta(self, index: int) -> tuple[_type[Any], Structure]: ...
...
class Structure(GObject.GBoxed):
    ...
    def get_enum(self, fieldname: str, enumtype: _type[Any]) -> tuple[bool, int]: ...
    def get_field_type(self, fieldname: str) -> _type[Any]: ...
    def get_flags(self, fieldname: str, flags_type: _type[Any]) -> tuple[bool, int]: ...
    ...
    def has_field_typed(self, fieldname: str, type: _type[Any]) -> bool: ...
    def has_name(self, name: str) -> bool: ...
    def id_get_value(self, field: int) -> Any | None: ...
    def id_has_field(self, field: int) -> bool: ...
    def id_has_field_typed(self, field: int, type: _type[Any]) -> bool: ...
    def id_set_value(self, field: int, value: Any) -> None: ...
    def id_str_get_field_type(self, fieldname: IdStr) -> _type[Any]: ...
    def id_str_get_value(self, fieldname: IdStr) -> Any | None: ...
    def id_str_has_field(self, fieldname: IdStr) -> bool: ...
    def id_str_has_field_typed(self, fieldname: IdStr, type: _type[Any]) -> bool: ...
