...
def context_replace(
    new_context: Context | None = None,
) -> tuple[bool, Context]: ...
def core_error_quark() -> int: ...
def debug(*args, **kwargs): ...  # FIXME: Override is missing typing annotation
...
def error(*args, **kwargs): ...  # FIXME: Override is missing typing annotation
...
def fixme(*args, **kwargs): ...  # FIXME: Override is missing typing annotation
...
def info(*args, **kwargs): ...  # FIXME: Override is missing typing annotation
def init(argv: list[str] | None = None) -> None: ...
def init_check(
    argv: list[str] | None = None,
) -> tuple[bool, list[str] | None]: ...
def init_python(): ...  # FIXME: Override is missing typing annotation
def is_caps_features(obj: None) -> bool: ...
def is_initialized() -> bool: ...
def library_error_quark() -> int: ...
def log(*args, **kwargs): ...  # FIXME: Override is missing typing annotation
def memdump(*args, **kwargs): ...  # FIXME: Override is missing typing annotation
def message_take(
...
def meta_api_type_set_params_aggregator(
    api: type[Any],
    aggregator: Callable[[Structure, Structure, Structure], bool],
) -> None: ...
...
def trace(*args, **kwargs): ...  # FIXME: Override is missing typing annotation
...
def warning(*args, **kwargs): ...  # FIXME: Override is missing typing annotation
...
class Bin(Element, ChildProxy):
    ...
    def iterate_all_by_interface(self, iface: type[Any]) -> Iterator: ...
    ...
    def make_and_add(self, factoryname: str, name: str | None = None) -> Element:
        """
        :raises Gst.AddError:
        """
    @classmethod
...
class Buffer(MiniObjectMixin, GObject.GBoxed):
    ...
    def map_range(self, idx: int, length: int, flags: MapFlags) -> MapInfo: ...
...
class BufferList(GObject.GBoxed):
    ...
    def foreach(
        self,
        func: Callable[..., tuple[bool, Buffer]],
        *user_data: Any,
    ) -> bool: ...
...
class Bus(Object):
    ...
    def set_sync_handler(
        self,
        func: Callable[..., BusSyncReply] | None = None,
        *user_data: Any,
    ) -> None: ...
...
class Element(Object):
    ...
    def iterate_pads(self) -> Iterator[Pad]: ...
    def iterate_sink_pads(self) -> Iterator[Pad]: ...
    def iterate_src_pads(self) -> Iterator[Pad]: ...
    def link(self, dest: Element) -> bool: ...
    def link_filtered(self, dest: Element, filter: Caps | None = None) -> bool: ...
    @staticmethod
    def link_many(*args: Element) -> None:
        """
...
class ElementFactory(PluginFeature):
    ...
    def get_klass(self) -> str | None: ...
    def get_longname(self) -> str | None: ...
    def get_metadata(self, key: str) -> str | None: ...
    def get_metadata_keys(self) -> list[str] | None: ...
...
class Iterator(GObject.GBoxed, Generic[T]):
    """
    :Constructors:
...
class Message(GObject.GBoxed):
    ...
    def parse_step_done(
        self,
    ) -> tuple[Format, int, float, bool, bool, int, bool]: ...
    def parse_step_start(
        self,
    ) -> tuple[bool, Format, int, float, bool, bool]: ...
    def parse_stream_collection(self) -> StreamCollection: ...
    ...
    def parse_structure_change(
        self,
    ) -> tuple[StructureChangeType, Element, bool]: ...
    def parse_tag(self) -> TagList: ...
    def parse_toc(self) -> tuple[Toc, bool]: ...
...
class Pad(Object):
    ...
    def set_chain_function(self, func: Callable[..., FlowReturn]) -> None: ...
    ...
    def set_event_function(self, func: Callable[..., FlowReturn]) -> None: ...
    ...
    def set_query_function(self, func: Callable[..., FlowReturn]) -> None: ...
...
class Structure(GObject.GBoxed):
    ...
    @staticmethod
    def __new__(
        cls: type[Self], arg: str | Structure, **kwargs
...
class TagList(GObject.GBoxed):
    ...
    def enumerate(self) -> map[tuple[str, Any]]: ...
