...
class Pty(GObject.Object, Gio.Initable):
    ...
    def new_foreign_sync(
        cls, fd: int, cancellable: Gio.Cancellable | None = None
    ) -> Pty: ...
    @classmethod
    def new_sync(
        cls, flags: PtyFlags, cancellable: Gio.Cancellable | None = None
    ) -> Pty: ...
...
class Terminal(_Gtk3.Widget, Atk.ImplementorIface, _Gtk3.Buildable, _Gtk3.Scrollable):
    class Props(_Gtk3.Widget.Props):
        allow_bold: bool
    ...
    def event_check_regex_simple(
        self, event: _Gdk3.Event, regexes: Sequence[Regex], match_flags: int
    ) -> list[str] | None: ...
    def feed(self, data: Sequence[int] | None = None) -> None: ...
    def feed_child(self, text: Sequence[int] | None = None) -> None: ...
    def feed_child_binary(self, data: Sequence[int] | None = None) -> None: ...
    ...
    def get_color_background_for_draw(self) -> _Gdk3.RGBA: ...
    ...
    def get_geometry_hints(self, min_rows: int, min_columns: int) -> _Gdk3.Geometry: ...
    ...
    def get_text(
        self, is_selected: Callable[..., bool] | None = None, *user_data: Any
    ) -> tuple[str | None, list[CharAttributes]]: ...
    ...
    def get_text_selected(self, format: Format) -> str | None: ...
    def get_window_title(self) -> str | None: ...
    def get_word_char_exceptions(self) -> str | None: ...
    def hyperlink_check_event(self, event: _Gdk3.Event) -> str | None: ...
    ...
    def match_check_event(self, event: _Gdk3.Event) -> tuple[str | None, int]: ...
    def match_remove(self, tag: int) -> None: ...
    def match_remove_all(self) -> None: ...
    def match_set_cursor(
        self, tag: int, cursor: _Gdk3.Cursor | None = None
    ) -> None: ...
    def match_set_cursor_name(self, tag: int, cursor_name: str) -> None: ...
    def match_set_cursor_type(
        self, tag: int, cursor_type: _Gdk3.CursorType
    ) -> None: ...
    @classmethod
    ...
    def pty_new_sync(
        self, flags: PtyFlags, cancellable: Gio.Cancellable | None = None
    ) -> Pty: ...
    ...
    def search_set_gregex(
        self, gregex: GLib.Regex | None, gflags: GLib.RegexMatchFlags
    ) -> None: ...
    ...
    def set_color_background(self, background: _Gdk3.RGBA) -> None: ...
    def set_color_bold(self, bold: _Gdk3.RGBA | None = None) -> None: ...
    def set_color_cursor(self, cursor_background: _Gdk3.RGBA | None = None) -> None: ...
    def set_color_cursor_foreground(
        self, cursor_foreground: _Gdk3.RGBA | None = None
    ) -> None: ...
    def set_color_foreground(self, foreground: _Gdk3.RGBA) -> None: ...
    def set_color_highlight(
        self, highlight_background: _Gdk3.RGBA | None = None
    ) -> None: ...
    def set_color_highlight_foreground(
        self, highlight_foreground: _Gdk3.RGBA | None = None
    ) -> None: ...
    def set_colors(
        self,
        foreground: _Gdk3.RGBA | None = None,
        background: _Gdk3.RGBA | None = None,
        palette: Sequence[_Gdk3.RGBA] | None = None,
    ) -> None: ...
    ...
    def set_encoding(self, codeset: str | None = None) -> bool: ...
    def set_font(self, font_desc: Pango.FontDescription | None = None) -> None: ...
    def set_font_scale(self, scale: float) -> None: ...
    def set_geometry_hints_for_window(self, window: _Gtk3.Window) -> None: ...
    def set_input_enabled(self, enabled: bool) -> None: ...
    def set_mouse_autohide(self, setting: bool) -> None: ...
    def set_pty(self, pty: Pty | None = None) -> None: ...
...
class TerminalClass(GObject.GPointer):
    parent_class: _Gtk3.WidgetClass
