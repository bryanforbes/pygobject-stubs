...
EventListener: TypeAlias = Callable[[Object], None]
EventListenerInit: TypeAlias = Callable[[], None]
FocusHandler: TypeAlias = Callable[[Object, bool], None]
Function: TypeAlias = Callable[[Unpack[_DataTs]], bool]
KeySnoopFunc: TypeAlias = Callable[[KeyEventStruct, Unpack[_DataTs]], int]
PropertyChangeHandler: TypeAlias = Callable[[Object, PropertyValues], None]
...
class ComponentIface(_gi.Struct):
    ...
    def parent(self) -> GObject.TypeInterface: ...
    @property
    def add_focus_handler(self) -> int | Any | None: ...
    @property
...
class Document(GObject.GInterface, Protocol):
    ...
    def get_attributes(self) -> list[int | Any | None]: ...
    def get_current_page_number(self) -> int: ...
    def get_document(self) -> int | Any | None: ...
...
class DocumentIface(_gi.Struct):
    ...
    @property
    def get_document(self) -> Callable[[Document], int | Any | None]: ...
    @property
    def get_document_locale(self) -> Callable[[Document], str]: ...
    @property
    def get_document_attributes(
        self,
    ) -> Callable[[Document], list[int | Any | None]]: ...
    @property
...
class GObjectAccessibleClass(_gi.Struct):
    ...
    @property
    def pad1(self) -> Function: ...
    @property
    def pad2(self) -> Function: ...
...
class MiscClass(_gi.Struct):
    ...
    @property
    def vfuncs(self) -> list[int | Any | None]: ...
...
class Object(GObject.Object):
    ...
    def do_get_attributes(self) -> list[int | Any | None]: ...
    ...
    def initialize(self, data: int | Any | None = ...) -> None: ...
...
class ObjectClass(_gi.Struct):
    ...
    @property
    def ref_child(self) -> int | Any | None: ...
    @property
    ...
    @property
    def connect_property_change_handler(self) -> int | Any | None: ...
    @property
    def remove_property_change_handler(self) -> Callable[[Object, int], None]: ...
    @property
    def initialize(self) -> Callable[[Object, int | Any | None], None]: ...
    @property
    def children_changed(self) -> Callable[[Object, int, int | Any | None], None]: ...
    @property
    ...
    def active_descendant_changed(
        self,
    ) -> Callable[[Object, int | Any | None], None]: ...
    @property
    def get_attributes(self) -> Callable[[Object], list[int | Any | None]]: ...
    @property
...
class ObjectFactoryClass(_gi.Struct):
    ...
    @property
    def create_accessible(self) -> int | Any | None: ...
    @property
...
class Registry(GObject.Object):
    ...
    def parent(self) -> GObject.Object: ...
    @property
    def factory_type_registry(self) -> dict[int | Any | None, int | Any | None]: ...
    @property
    def factory_singleton_cache(self) -> dict[int | Any | None, int | Any | None]: ...
...
class Relation(GObject.Object):
    ...
    def parent(self) -> GObject.Object: ...
    @property
    def target(self) -> list[int | Any | None]: ...
    @property
...
class RelationSet(GObject.Object):
    ...
    def parent(self) -> GObject.Object: ...
    @property
    def relations(self) -> list[int | Any | None]: ...
...
class Text(GObject.GInterface, Protocol):
    ...
    def get_default_attributes(self) -> list[int | Any | None]: ...
    ...
    def get_run_attributes(
        self, offset: int
    ) -> tuple[list[int | Any | None], int, int]: ...
...
class TextIface(_gi.Struct):
    ...
    def get_run_attributes(
        self,
    ) -> Callable[[Text, int], tuple[list[int | Any | None], int, int]]: ...
    @property
    def get_default_attributes(self) -> Callable[[Text], list[int | Any | None]]: ...
    @property
    def get_character_extents(
        self,
...
class UtilClass(_gi.Struct):
    ...
    def parent(self) -> GObject.ObjectClass: ...
    @property
    def add_global_event_listener(self) -> int | Any | None: ...
    @property
    def remove_global_event_listener(self) -> Callable[[int], None]: ...
    @property
    def add_key_event_listener(self) -> int | Any | None: ...
    @property
    def remove_key_event_listener(self) -> Callable[[int], None]: ...
    @property
    def get_root(self) -> int | Any | None: ...
    @property
