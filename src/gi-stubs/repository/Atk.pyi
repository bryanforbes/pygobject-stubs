...
class ActionIface(GObject.GPointer):
    ...
    get_description: Callable[[Action, int], str | None]
    get_name: Callable[[Action, int], str | None]
    get_keybinding: Callable[[Action, int], str | None]
    set_description: Callable[[Action, int, str], bool]
    get_localized_name: Callable[[Action, int], str | None]
...
class ComponentIface(GObject.GPointer):
    ...
    ref_accessible_at_point: Callable[[Component, int, int, CoordType], Object | None]
...
class DocumentIface(GObject.GPointer):
    ...
    get_document_attribute_value: Callable[[Document, str], str | None]
...
class ImageIface(GObject.GPointer):
    ...
    get_image_locale: Callable[[Image], str | None]
...
class SelectionIface(GObject.GPointer):
    ...
    ref_selection: Callable[[Selection, int], Object | None]
...
class StreamableContentIface(GObject.GPointer):
    ...
    get_uri: Callable[[StreamableContent, str], str | None]
    pad1: Callable[..., bool]
    pad2: Callable[..., bool]
    pad3: Callable[..., bool]
...
class TableIface(GObject.GPointer):
    ...
    get_caption: Callable[[Table], Object | None]
    get_column_description: Callable[[Table, int], str]
    get_column_header: Callable[[Table, int], Object | None]
    get_row_description: Callable[[Table, int], str | None]
    get_row_header: Callable[[Table, int], Object | None]
...
class TextIface(GObject.GPointer):
    ...
    get_text_before_offset: Callable[[Text, int, TextBoundary], tuple[str, int, int]]
    ...
    get_character_extents: Callable[[Text, int, CoordType], tuple[int, int, int, int]]
    ...
    get_string_at_offset: Callable[
        [Text, int, TextGranularity], tuple[str | None, int, int]
    ]
...
class ValueIface(GObject.GPointer):
    ...
    get_range: Callable[[Value], Range | None]
