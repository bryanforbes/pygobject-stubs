...
def buffer_add_rtp_source_meta(
    buffer: Gst.Buffer, ssrc: int | None = ..., csrc: Sequence[int] | None = ...
) -> RTPSourceMeta: ...
...
def rtp_buffer_ext_timestamp(exttimestamp: int, timestamp: int) -> tuple[int, int]: ...
...
def rtp_hdrext_set_ntp_56(data: int | Any | None, size: int, ntptime: int) -> bool: ...
def rtp_hdrext_set_ntp_64(data: int | Any | None, size: int, ntptime: int) -> bool: ...
...
class RTPBasePayload(Gst.Element):
    ...
    def set_outcaps_structure(self, s: Gst.Structure | None = ...) -> bool: ...
    def set_source_info_enabled(self, enable: bool) -> None: ...
...
class RTPSourceMeta(_gi.Struct):
    ...
    def set_ssrc(self, ssrc: int | None = ...) -> bool: ...
