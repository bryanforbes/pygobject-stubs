...
CacheDestroyFunc: TypeAlias = Callable[[Any], None]
CacheDupFunc: TypeAlias = Callable[[Any], Any | None]
CacheNewFunc: TypeAlias = Callable[[Any], Any | None]
ChildWatchFunc: TypeAlias = Callable[[int, int, Unpack[_DataTs]], None]
ClearHandleFunc: TypeAlias = Callable[[int], None]
# override
CompareDataFunc: TypeAlias = Callable[
    [_T_contra | None, _T_contra | None, Unpack[_DataTs]], int
]
# override
CompareFunc: TypeAlias = Callable[[_T_contra | None, _T_contra | None], int]
CompletionFunc: TypeAlias = Callable[[Any], str]
CompletionStrncmpFunc: TypeAlias = Callable[[str, str, int], int]
CopyFunc: TypeAlias = Callable[[Any, Any], Any]
DataForeachFunc: TypeAlias = Callable[[int, Any, Unpack[_DataTs]], None]
DestroyNotify: TypeAlias = Callable[[Any], None]
DuplicateFunc: TypeAlias = Callable[[Any, Unpack[_DataTs]], Any | None]
# override
EqualFunc: TypeAlias = Callable[[_T_contra | None, _T_contra | None], bool]
# override
EqualFuncFull: TypeAlias = Callable[
    [_T_contra | None, _T_contra | None, Unpack[_DataTs]], bool
]
ErrorClearFunc: TypeAlias = Callable[[GError], None]
ErrorCopyFunc: TypeAlias = Callable[[GError, GError], None]
ErrorInitFunc: TypeAlias = Callable[[GError], None]
FreeFunc: TypeAlias = Callable[[Any], None]
Func: TypeAlias = Callable[[Any, Unpack[_DataTs]], None]
HFunc: TypeAlias = Callable[[Any, Any, Unpack[_DataTs]], None]
HRFunc: TypeAlias = Callable[[Any, Any, Unpack[_DataTs]], bool]
HashFunc: TypeAlias = Callable[[Any], int]
HookCheckFunc: TypeAlias = Callable[[Any], bool]
# override
HookCheckMarshaller: TypeAlias = Callable[[Hook, Unpack[_DataTs]], bool]
HookCompareFunc: TypeAlias = Callable[[Hook, Hook], int]
HookFinalizeFunc: TypeAlias = Callable[[HookList, Hook], None]
HookFindFunc: TypeAlias = Callable[[Hook, Any], bool]
HookFunc: TypeAlias = Callable[[Any], None]
# override
HookMarshaller: TypeAlias = Callable[[Hook, Unpack[_DataTs]], None]
IOFunc: TypeAlias = Callable[[IOChannel, IOCondition, Any], bool]
LogFunc: TypeAlias = Callable[[str | None, LogLevelFlags, str, Unpack[_DataTs]], None]
LogWriterFunc: TypeAlias = Callable[
    [LogLevelFlags, list[LogField], Unpack[_DataTs]], LogWriterOutput
]
# override
NodeForeachFunc: TypeAlias = Callable[[Node, Unpack[_DataTs]], None]
# override
NodeTraverseFunc: TypeAlias = Callable[[Node, Unpack[_DataTs]], bool]
OptionArgFunc: TypeAlias = Callable[[str, str, Any], bool]
OptionErrorFunc: TypeAlias = Callable[[OptionContext, OptionGroup, Any], None]
OptionParseFunc: TypeAlias = Callable[[OptionContext, OptionGroup, Any], bool]
PollFunc: TypeAlias = Callable[[PollFD, int, int], int]
PrintFunc: TypeAlias = Callable[[str], None]
RegexEvalCallback: TypeAlias = Callable[[MatchInfo, String, Unpack[_DataTs]], bool]
ScannerMsgFunc: TypeAlias = Callable[[Scanner, str, bool], None]
# override
SequenceIterCompareFunc: TypeAlias = Callable[
    [SequenceIter, SequenceIter, Unpack[_DataTs]], int
]
SourceDisposeFunc: TypeAlias = Callable[[Source], None]
SourceDummyMarshal: TypeAlias = Callable[[], None]
SourceFunc: TypeAlias = Callable[[Unpack[_DataTs]], bool]
SourceFuncsCheckFunc: TypeAlias = Callable[[Source], bool]
SourceFuncsFinalizeFunc: TypeAlias = Callable[[Source], None]
SourceFuncsPrepareFunc: TypeAlias = Callable[[Source], tuple[bool, int]]
SourceOnceFunc: TypeAlias = Callable[[Unpack[_DataTs]], None]
# override
SpawnChildSetupFunc: TypeAlias = Callable[[Unpack[_DataTs]], None]
TestDataFunc: TypeAlias = Callable[[Unpack[_DataTs]], None]
TestFixtureFunc: TypeAlias = Callable[[Any, Unpack[_DataTs]], None]
TestFunc: TypeAlias = Callable[[], None]
TestLogFatalFunc: TypeAlias = Callable[[str, LogLevelFlags, str, Unpack[_DataTs]], bool]
# override
ThreadFunc: TypeAlias = Callable[[Unpack[_DataTs]], Any | None]
# override
TranslateFunc: TypeAlias = Callable[[str, Unpack[_DataTs]], str]
# override
TraverseFunc: TypeAlias = Callable[[Any, Any, Unpack[_DataTs]], bool]
# override
TraverseNodeFunc: TypeAlias = Callable[[TreeNode, Unpack[_DataTs]], bool]
UnixFDSourceFunc: TypeAlias = Callable[[int, IOCondition, Unpack[_DataTs]], bool]
VoidFunc: TypeAlias = Callable[[], None]
...
def aligned_alloc(
    n_blocks: int, n_block_bytes: int, alignment: int
) -> int | Any | None: ...
def aligned_alloc0(
    n_blocks: int, n_block_bytes: int, alignment: int
) -> int | Any | None: ...
def aligned_free(mem: int | Any | None = ...) -> None: ...
def aligned_free_sized(mem: int | Any | None, alignment: int, size: int) -> None: ...
...
def atomic_int_add(atomic: int | Any | None, val: int) -> int: ...
def atomic_int_and(atomic: int | Any | None, val: int) -> int: ...
def atomic_int_compare_and_exchange(
    atomic: int | Any | None, oldval: int, newval: int
) -> bool: ...
def atomic_int_compare_and_exchange_full(
    atomic: int | Any | None, oldval: int, newval: int
) -> tuple[bool, int]: ...
def atomic_int_dec_and_test(atomic: int | Any | None = ...) -> bool: ...
def atomic_int_exchange(atomic: int | Any | None, newval: int) -> int: ...
def atomic_int_exchange_and_add(atomic: int | Any | None, val: int) -> int: ...
def atomic_int_get(atomic: int | Any | None = ...) -> int: ...
def atomic_int_inc(atomic: int | Any | None = ...) -> None: ...
def atomic_int_or(atomic: int | Any | None, val: int) -> int: ...
def atomic_int_set(atomic: int | Any | None, newval: int) -> None: ...
def atomic_int_xor(atomic: int | Any | None, val: int) -> int: ...
def atomic_pointer_add(atomic: int | Any | None, val: int) -> int: ...
def atomic_pointer_and(atomic: int | Any | None, val: int) -> int: ...
...
def atomic_pointer_exchange(
    atomic: int | Any | None = ..., newval: int | Any | None = ...
) -> int | Any | None: ...
def atomic_pointer_get(atomic: int | Any | None) -> int | Any | None: ...
def atomic_pointer_or(atomic: int | Any | None, val: int) -> int: ...
def atomic_pointer_set(
    atomic: int | Any | None, newval: int | Any | None = ...
) -> None: ...
def atomic_pointer_xor(atomic: int | Any | None, val: int) -> int: ...
def atomic_rc_box_acquire(mem_block: int | Any | None) -> int | Any | None: ...
def atomic_rc_box_alloc(block_size: int) -> int | Any | None: ...
def atomic_rc_box_alloc0(block_size: int) -> int | Any | None: ...
def atomic_rc_box_dup(
    block_size: int, mem_block: int | Any | None
) -> int | Any | None: ...
def atomic_rc_box_get_size(mem_block: int | Any | None) -> int: ...
def atomic_rc_box_release(mem_block: int | Any | None) -> None: ...
def atomic_rc_box_release_full(
    mem_block: int | Any | None, clear_func: DestroyNotify
) -> None: ...
...
def base64_decode_inplace(text: _Sequence[int]) -> tuple[int, bytes]: ...
def base64_encode(data: _Sequence[int] | None = ...) -> str: ...
def base64_encode_close(
    break_lines: bool, state: int, save: int
) -> tuple[int, bytes, int, int]: ...
def base64_encode_step(
    in_: _Sequence[int], break_lines: bool, state: int, save: int
) -> tuple[int, bytes, int, int]: ...
def basename(file_name: str) -> str: ...
def bit_lock(address: int | Any | None, lock_bit: int) -> None: ...
def bit_lock_and_get(address: int | Any | None, lock_bit: int) -> int: ...
def bit_nth_lsf(mask: int, nth_bit: int) -> int: ...
def bit_nth_msf(mask: int, nth_bit: int) -> int: ...
def bit_storage(number: int) -> int: ...
def bit_trylock(address: int | Any | None, lock_bit: int) -> bool: ...
def bit_unlock(address: int | Any | None, lock_bit: int) -> None: ...
def bit_unlock_and_set(
    address: int | Any | None, lock_bit: int, new_val: int, preserve_mask: int
) -> None: ...
...
def byte_array_sort(array: _Sequence[int], compare_func: CompareFunc) -> None: ...

# override
def byte_array_sort_with_data(
    array: _Sequence[int],
    compare_func: CompareDataFunc[int, Unpack[_DataTs]],
    *user_data: Unpack[_DataTs],
) -> None: ...
def byte_array_steal(array: _Sequence[int]) -> bytes: ...
def byte_array_unref(array: _Sequence[int]) -> None: ...
def canonicalize_filename(filename: str, relative_to: str | None = ...) -> str: ...
...
def datalist_foreach(
    datalist: Data, func: DataForeachFunc[Unpack[_DataTs]], *user_data: Unpack[_DataTs]
) -> None: ...
def datalist_get_data(datalist: Data, key: str) -> int | Any | None: ...
def datalist_get_flags(datalist: Data) -> int: ...
def datalist_id_get_data(datalist: Data, key_id: int) -> int | Any | None: ...
...
def dataset_destroy(dataset_location: int | Any | None) -> None: ...
def dataset_foreach(
    dataset_location: int | Any | None,
    func: DataForeachFunc[Unpack[_DataTs]],
    *user_data: Unpack[_DataTs],
) -> None: ...
def dataset_id_get_data(
    dataset_location: int | Any | None, key_id: int
) -> int | Any | None: ...
...
def dir_make_tmp(tmpl: str | None = ...) -> str: ...
def direct_equal(v1: int | Any | None = ..., v2: int | Any | None = ...) -> bool: ...
def direct_hash(v: int | Any | None = ...) -> int: ...
def dngettext(domain: str | None, msgid: str, msgid_plural: str, n: int) -> str: ...
def double_equal(v1: int | Any | None, v2: int | Any | None) -> bool: ...
def double_hash(v: int | Any | None) -> int: ...
...
def file_open_tmp(tmpl: str | None = ...) -> tuple[int, str]: ...
...
def filename_from_uri(uri: str) -> tuple[str, str | None]: ...
def filename_from_utf8(utf8string: str, len: int = 1) -> str: ...
def filename_to_uri(filename: str, hostname: str | None = ...) -> str: ...
def filename_to_utf8(opsysstring: str, len: int) -> tuple[str, int, int]: ...
def find_program_in_path(program: str) -> str | None: ...
def fopen(filename: str, mode: str) -> int | Any | None: ...
def format_size(size: int) -> str: ...
def format_size_for_display(size: int) -> str: ...
def format_size_full(size: int, flags: FormatSizeFlags) -> str: ...
def free(mem: int | Any | None = ...) -> None: ...
def free_sized(mem: int | Any | None, size: int) -> None: ...
def freopen(
    filename: str, mode: str, stream: int | Any | None = ...
) -> int | Any | None: ...
...
def hash_table_add(
    hash_table: Mapping[int | Any | None, int | Any | None], key: int | Any | None = ...
) -> bool: ...
def hash_table_contains(
    hash_table: Mapping[int | Any | None, int | Any | None], key: int | Any | None = ...
) -> bool: ...
def hash_table_destroy(
    hash_table: Mapping[int | Any | None, int | Any | None],
) -> None: ...
def hash_table_find(
    hash_table: Mapping[int | Any | None, int | Any | None],
    predicate: HRFunc[Unpack[_DataTs]],
    *user_data: Unpack[_DataTs],
) -> int | Any | None: ...
def hash_table_foreach(
    hash_table: Mapping[int | Any | None, int | Any | None],
    func: HFunc[Unpack[_DataTs]],
    *user_data: Unpack[_DataTs],
) -> None: ...
def hash_table_foreach_remove(
    hash_table: Mapping[int | Any | None, int | Any | None],
    func: HRFunc[Unpack[_DataTs]],
    *user_data: Unpack[_DataTs],
) -> int: ...
...
def hash_table_lookup_extended(
    hash_table: Mapping[int | Any | None, int | Any | None],
    lookup_key: int | Any | None = ...,
) -> tuple[bool, int | Any | None, int | Any | None]: ...
def hash_table_new_similar(
    other_hash_table: Mapping[int | Any | None, int | Any | None],
) -> dict[int | Any | None, int | Any | None]: ...
def hash_table_ref(
    hash_table: Mapping[int | Any | None, int | Any | None],
) -> dict[int | Any | None, int | Any | None]: ...
...
def hash_table_size(hash_table: Mapping[int | Any | None, int | Any | None]) -> int: ...
...
def hook_insert_sorted(
    hook_list: HookList, hook: Hook, func: HookCompareFunc
) -> None: ...
...
def idle_remove_by_data(data: int | Any | None = ...) -> bool: ...
def idle_source_new() -> Source: ...
def int64_equal(v1: int | Any | None, v2: int | Any | None) -> bool: ...
def int64_hash(v: int | Any | None) -> int: ...
def int_equal(v1: int | Any | None, v2: int | Any | None) -> bool: ...
def int_hash(v: int | Any | None) -> int: ...
...
def log_set_handler(
    ...
    log_func: LogFunc[Unpack[_DataTs]],
    *user_data: Unpack[_DataTs],
) -> int: ...
def log_set_writer_func(*user_data: Unpack[_DataTs]) -> None: ...
...
def log_writer_default_would_drop(
    log_level: LogLevelFlags, log_domain: str | None = ...
) -> bool: ...
...
def main_depth() -> int: ...
def malloc(n_bytes: int) -> int | Any | None: ...
def malloc0(n_bytes: int) -> int | Any | None: ...
def malloc0_n(n_blocks: int, n_block_bytes: int) -> int | Any | None: ...
def malloc_n(n_blocks: int, n_block_bytes: int) -> int | Any | None: ...
...
def memdup(mem: int | Any | None, byte_size: int) -> int | Any | None: ...
def memdup2(mem: int | Any | None, byte_size: int) -> int | Any | None: ...
...
def nullify_pointer(nullify_location: int | Any | None) -> None: ...
def number_parser_error_quark() -> int: ...
def on_error_query(prg_name: str) -> None: ...
def on_error_stack_trace(prg_name: str | None = ...) -> None: ...
def once_init_enter(location: int | Any | None) -> tuple[bool, int | Any | None]: ...
def once_init_enter_impl(location: int) -> bool: ...
def once_init_enter_pointer(location: int | Any | None) -> bool: ...
def once_init_leave(location: int | Any | None, result: int) -> int | Any | None: ...
def once_init_leave_pointer(
    location: int | Any | None, result: int | Any | None = ...
) -> None: ...
...
def path_buf_equal(v1: int | Any | None, v2: int | Any | None) -> bool: ...
...
def pointer_bit_lock(address: int | Any | None, lock_bit: int) -> None: ...
def pointer_bit_lock_and_get(address: int | Any | None, lock_bit: int) -> int: ...
def pointer_bit_lock_mask_ptr(
    ptr: int | Any | None,
    lock_bit: int,
    set: bool,
    preserve_mask: int,
    preserve_ptr: int | Any | None = ...,
) -> int | Any | None: ...
def pointer_bit_trylock(address: int | Any | None, lock_bit: int) -> bool: ...
def pointer_bit_unlock(address: int | Any | None, lock_bit: int) -> None: ...
def pointer_bit_unlock_and_set(
    address: int | Any | None, lock_bit: int, ptr: int | Any | None, preserve_mask: int
) -> None: ...
def poll(fds: PollFD, nfds: int, timeout: int) -> int: ...
def prefix_error_literal(err: Error | None, prefix: str) -> Error | None: ...
def propagate_error(src: Error) -> Error | None: ...
...
def qsort_with_data(
    ...
    total_elems: int,
    size: int,
    compare_func: CompareDataFunc[Any, Unpack[_DataTs]],
    *user_data: Unpack[_DataTs],
) -> None: ...
def quark_from_static_string(string: str | None = ...) -> int: ...
def quark_from_string(string: str | None = ...) -> int: ...
def quark_to_string(quark: int) -> str: ...
def quark_try_string(string: str | None = ...) -> int: ...
...
def rc_box_acquire(mem_block: int | Any | None) -> int | Any | None: ...
def rc_box_alloc(block_size: int) -> int | Any | None: ...
def rc_box_alloc0(block_size: int) -> int | Any | None: ...
def rc_box_dup(block_size: int, mem_block: int | Any | None) -> int | Any | None: ...
def rc_box_get_size(mem_block: int | Any | None) -> int: ...
def rc_box_release(mem_block: int | Any | None) -> None: ...
def rc_box_release_full(
    mem_block: int | Any | None, clear_func: DestroyNotify
) -> None: ...
def realloc(mem: int | Any | None, n_bytes: int) -> int | Any | None: ...
def realloc_n(
    mem: int | Any | None, n_blocks: int, n_block_bytes: int
) -> int | Any | None: ...
...
def sequence_foreach_range(
    ...
    func: Func[Unpack[_DataTs]],
    *user_data: Unpack[_DataTs],
) -> None: ...
def sequence_get(iter: SequenceIter) -> int | Any | None: ...
def sequence_insert_before(
    iter: SequenceIter, data: int | Any | None = ...
) -> SequenceIter: ...
...
def sequence_set(iter: SequenceIter, data: int | Any | None = ...) -> None: ...

# override
def sequence_sort_changed(
    iter: SequenceIter,
    cmp_func: CompareDataFunc[Any, Unpack[_DataTs]],
    *cmp_data: Unpack[_DataTs],
) -> None: ...
def sequence_sort_changed_iter(
    iter: SequenceIter,
    iter_cmp: SequenceIterCompareFunc[Unpack[_DataTs]],
    *cmp_data: Unpack[_DataTs],
) -> None: ...
...
def slice_alloc(block_size: int) -> int | Any | None: ...
def slice_alloc0(block_size: int) -> int | Any | None: ...
def slice_copy(
    block_size: int, mem_block: int | Any | None = ...
) -> int | Any | None: ...
def slice_free1(block_size: int, mem_block: int | Any | None = ...) -> None: ...
def slice_free_chain_with_offset(
    block_size: int, mem_chain: int | Any | None, next_offset: int
) -> None: ...
...
def source_remove_by_funcs_user_data(
    funcs: SourceFuncs, user_data: int | Any | None = ...
) -> bool: ...
def source_remove_by_user_data(user_data: int | Any | None = ...) -> bool: ...
...
def spawn_async_with_fds(
    ...
    flags: SpawnFlags,
    child_setup: SpawnChildSetupFunc[Unpack[_DataTs]] | None,
    stdin_fd: int,
    stdout_fd: int,
    stderr_fd: int,
    *user_data: Unpack[_DataTs],
...
def spawn_async_with_pipes_and_fds(
    ...
    stdout_fd: int,
    stderr_fd: int,
    source_fds: _Sequence[int] | None = ...,
    target_fds: _Sequence[int] | None = ...,
    *user_data: Unpack[_DataTs],
) -> tuple[bool, int, int, int, int]: ...
...
def str_tokenize_and_fold(
    string: str, translit_locale: str | None = ...
...
def strdupv(str_array: _Sequence[str] | None = ...) -> list[str] | None: ...
def strerror(errnum: int) -> str: ...
def strescape(source: str, exceptions: str | None = ...) -> str: ...
def strfreev(str_array: _Sequence[str] | None = ...) -> None: ...
...
def test_add_data_func(
    testpath: str, test_data: int | Any | None, test_func: TestDataFunc
) -> None: ...
...
def test_queue_destroy(
    destroy_func: DestroyNotify, destroy_data: int | Any | None = ...
) -> None: ...
def test_queue_free(gfree_pointer: int | Any | None = ...) -> None: ...
...
def thread_exit(retval: int | Any | None = ...) -> None: ...
...
def trash_stack_peek(stack_p: TrashStack) -> int | Any | None: ...
def trash_stack_pop(stack_p: TrashStack) -> int | Any | None: ...
def trash_stack_push(stack_p: TrashStack, data_p: int | Any | None) -> None: ...
def try_malloc(n_bytes: int) -> int | Any | None: ...
def try_malloc0(n_bytes: int) -> int | Any | None: ...
def try_malloc0_n(n_blocks: int, n_block_bytes: int) -> int | Any | None: ...
def try_malloc_n(n_blocks: int, n_block_bytes: int) -> int | Any | None: ...
def try_realloc(mem: int | Any | None, n_bytes: int) -> int | Any | None: ...
def try_realloc_n(
    mem: int | Any | None, n_blocks: int, n_block_bytes: int
) -> int | Any | None: ...
...
def uri_escape_bytes(
    unescaped: _Sequence[int], reserved_chars_allowed: str | None = ...
) -> str: ...
...
def uri_unescape_bytes(
    escaped_string: str, length: int, illegal_characters: str | None = ...
) -> Bytes: ...
def uri_unescape_segment(
    escaped_string: str | None = ...,
    escaped_string_end: str | None = ...,
    illegal_characters: str | None = ...,
) -> str | None: ...
def uri_unescape_string(
    escaped_string: str, illegal_characters: str | None = ...
) -> str | None: ...
...
def utime(filename: str, utb: int | Any | None = ...) -> int: ...
...
class AsyncQueue(_gi.Struct):
    ...
    def pop(self) -> int | Any | None: ...
    def pop_unlocked(self) -> int | Any | None: ...
    def push(self, data: int | Any | None) -> None: ...
    def push_front(self, item: int | Any | None) -> None: ...
    def push_front_unlocked(self, item: int | Any | None) -> None: ...
    # override
    def push_sorted(
        self,
        data: Any,
        func: CompareDataFunc[Any, Unpack[_DataTs]],
        *user_data: Unpack[_DataTs],
    ) -> None: ...
    # override
    ...
    def push_unlocked(self, data: int | Any | None) -> None: ...
    def ref(self) -> AsyncQueue: ...
    def ref_unlocked(self) -> None: ...
    def remove(self, item: int | Any | None) -> bool: ...
    def remove_unlocked(self, item: int | Any | None) -> bool: ...
    # override
    def sort(
        self, func: CompareDataFunc[Any, Unpack[_DataTs]], *user_data: Unpack[_DataTs]
    ) -> None: ...
    # override
    def sort_unlocked(
        self, func: CompareDataFunc[Any, Unpack[_DataTs]], *user_data: Unpack[_DataTs]
    ) -> None: ...
    def timed_pop(self, end_time: TimeVal) -> int | Any | None: ...
    def timed_pop_unlocked(self, end_time: TimeVal) -> int | Any | None: ...
    def timeout_pop(self, timeout: int) -> int | Any | None: ...
    def timeout_pop_unlocked(self, timeout: int) -> int | Any | None: ...
    def try_pop(self) -> int | Any | None: ...
    def try_pop_unlocked(self) -> int | Any | None: ...
...
class BookmarkFile(GObject.GBoxed):
    ...
    def add_application(
        self, uri: str, name: str | None = ..., exec: str | None = ...
    ) -> None: ...
    ...
    def set_application_info(
        self, uri: str, name: str, exec: str, count: int, stamp: DateTime | None = ...
    ) -> bool: ...
    def set_description(self, uri: str | None, description: str) -> None: ...
    def set_groups(self, uri: str, groups: _Sequence[str] | None = ...) -> None: ...
...
class ByteArray(GObject.GBoxed):
    ...
    @staticmethod
    def sort(array: _Sequence[int], compare_func: CompareFunc) -> None: ...
    # override
    @staticmethod
    def sort_with_data(
        array: _Sequence[int],
...
class Bytes(GObject.GBoxed):
    ...
    """
    def __init__(self, data: _Sequence[int] | None = ...) -> None: ...
    def compare(self, bytes2: Bytes) -> int: ...
    def equal(self, bytes2: Bytes) -> bool: ...
    def get_data(self) -> bytes | None: ...
    def get_region(
        self, element_size: int, offset: int, n_elements: int
    ) -> int | Any | None: ...
    def get_size(self) -> int: ...
    def hash(self) -> int: ...
    @classmethod
    def new(cls, data: _Sequence[int] | None = ...) -> Bytes: ...
    def new_from_bytes(self, offset: int, length: int) -> Bytes: ...
    @classmethod
    def new_take(cls, data: _Sequence[int] | None = ...) -> Bytes: ...
    def ref(self) -> Bytes: ...
    def unref(self) -> None: ...
...
class Cache(_gi.Struct):
    ...
    def insert(self, key: int | Any | None = ...) -> int | Any | None: ...
    def key_foreach(
        self, func: HFunc[Unpack[_DataTs]], *user_data: Unpack[_DataTs]
    ) -> None: ...
    def remove(self, value: int | Any | None = ...) -> None: ...
    def value_foreach(
        self, func: HFunc[Unpack[_DataTs]], *user_data: Unpack[_DataTs]
    ) -> None: ...
...
class Completion(_gi.Struct):
    ...
    items: list[int | Any | None]
    func: CompletionFunc
    prefix: str
    cache: list[int | Any | None]
...
class Date(GObject.GBoxed):
    ...
    def to_struct_tm(self, tm: int | Any | None) -> None: ...
    def valid(self) -> bool: ...
    @staticmethod
...
class DateTime(GObject.GBoxed):
    ...
    def new_from_iso8601(
        cls, text: str, default_tz: TimeZone | None = ...
    ) -> DateTime | None: ...
    @classmethod
...
class Dir(GObject.GBoxed):
    ...
    def close(self) -> None: ...
    @staticmethod
    def make_tmp(tmpl: str | None = ...) -> str: ...
    @classmethod
...
class HashTable(GObject.GBoxed):
    ...
    @staticmethod
    def destroy(hash_table: Mapping[int | Any | None, int | Any | None]) -> None: ...
    @staticmethod
    def find(
        hash_table: Mapping[int | Any | None, int | Any | None],
        predicate: HRFunc[Unpack[_DataTs]],
    ...
    @staticmethod
    def remove_all(hash_table: Mapping[int | Any | None, int | Any | None]) -> None: ...
    @staticmethod
    def replace(
        hash_table: Mapping[int | Any | None, int | Any | None],
        key: int | Any | None = ...,
    ...
    @staticmethod
    def size(hash_table: Mapping[int | Any | None, int | Any | None]) -> int: ...
    @staticmethod
    def steal(
        hash_table: Mapping[int | Any | None, int | Any | None],
        key: int | Any | None = ...,
    ...
    @staticmethod
    def steal_all(hash_table: Mapping[int | Any | None, int | Any | None]) -> None: ...
    @staticmethod
    def steal_extended(
        hash_table: Mapping[int | Any | None, int | Any | None],
        lookup_key: int | Any | None = ...,
    ...
    @staticmethod
    def unref(hash_table: Mapping[int | Any | None, int | Any | None]) -> None: ...
...
class HashTableIter(_gi.Struct):
    ...
    """
    @property
    def dummy1(self) -> int | Any | None: ...
    @property
    def dummy2(self) -> int | Any | None: ...
    @property
    def dummy3(self) -> int | Any | None: ...
    @property
    def dummy4(self) -> int: ...
    @property
    def dummy5(self) -> bool: ...
    @property
    def dummy6(self) -> int | Any | None: ...
    def get_hash_table(self) -> dict[int | Any | None, int | Any | None]: ...
    def init(self, hash_table: Mapping[int | Any | None, int | Any | None]) -> None: ...
    def next(self) -> tuple[bool, int | Any | None, int | Any | None]: ...
    def remove(self) -> None: ...
    def replace(self, value: int | Any | None = ...) -> None: ...
    def steal(self) -> None: ...
...
class HookList(_gi.Struct):
    ...
    def marshal(
        self,
        may_recurse: bool,
        marshaller: HookMarshaller[Unpack[_DataTs]],
        *marshal_data: Unpack[_DataTs],
    ) -> None: ...
    def marshal_check(
        self,
        may_recurse: bool,
        marshaller: HookCheckMarshaller[Unpack[_DataTs]],
        *marshal_data: Unpack[_DataTs],
    ) -> None: ...
...
class IOChannel(GObject.GBoxed):
    ...
    @property
    def read_cd(self) -> int | Any | None: ...
    @property
    def write_cd(self) -> int | Any | None: ...
    @property
    ...
    @property
    def reserved1(self) -> int | Any | None: ...
    @property
    def reserved2(self) -> int | Any | None: ...
    def __init__(
        self,
    ...
    def add_watch(
        self,
        condition: IOCondition,
        callback: Callable[[Unpack[_DataTs]], bool | None],
        *user_data: Unpack[_DataTs],
        priority: int = 0,
    ) -> int: ...
    def close(self) -> None: ...
    ...
    def read_line_string(
        self, buffer: String, terminator_pos: int | None = ...
    ) -> IOStatus: ...
...
class KeyFile(GObject.GBoxed):
    ...
    def get_comment(
        self, group_name: str | None = ..., key: str | None = ...
    ) -> str: ...
    ...
    def get_locale_for_key(
        self, group_name: str, key: str, locale: str | None = ...
    ) -> str | None: ...
...
class List(_gi.Struct):
    ...
    data: int | Any | None
    next: list[int | Any | None]
    prev: list[int | Any | None]
    @staticmethod
...
class MainContext(GObject.GBoxed):
    ...
    def find_source_by_funcs_user_data(
        self, funcs: SourceFuncs, user_data: int | Any | None = ...
    ) -> Source | None: ...
    ...
    def invoke_full(
        self,
        priority: int,
        function: SourceFunc[Unpack[_DataTs]],
        *data: Unpack[_DataTs],
    ) -> None: ...
    ...
    def pusher_new(self) -> int | Any | None: ...
...
class MarkupParseContext(GObject.GBoxed):
    ...
    def pop(self) -> int | Any | None: ...
    def push(self, parser: MarkupParser, user_data: int | Any | None = ...) -> None: ...
...
class MarkupParser(_gi.Struct):
    ...
    def start_element(
        self,
    ) -> Callable[[MarkupParseContext, str, str, str, Unpack[_DataTs]], None]: ...
    @property
    def end_element(
        self,
    ) -> Callable[[MarkupParseContext, str, Unpack[_DataTs]], None]: ...
    @property
    def text(
        self,
    ) -> Callable[[MarkupParseContext, str, int, Unpack[_DataTs]], None]: ...
    @property
    def passthrough(
        self,
    ) -> Callable[[MarkupParseContext, str, int, Unpack[_DataTs]], None]: ...
    @property
    def error(self) -> Callable[[MarkupParseContext, Error, Unpack[_DataTs]], None]: ...
...
class MemChunk(_gi.Struct):
    def alloc(self) -> int | Any | None: ...
    def alloc0(self) -> int | Any | None: ...
    def clean(self) -> None: ...
    def destroy(self) -> None: ...
    def free(self, mem: int | Any | None = ...) -> None: ...
    @staticmethod
    def info() -> None: ...
...
class MemVTable(_gi.Struct):
    ...
    """
    @property
    def malloc(self) -> Callable[[int], int | Any | None]: ...
    @property
    def realloc(self) -> Callable[[int | Any | None, int], int | Any | None]: ...
    @property
    def free(self) -> Callable[[int | Any | None], None]: ...
    @property
    def calloc(self) -> Callable[[int, int], int | Any | None]: ...
    @property
    def try_malloc(self) -> Callable[[int], int | Any | None]: ...
    @property
    def try_realloc(self) -> Callable[[int | Any | None, int], int | Any | None]: ...
...
class Node(_gi.Struct):
    ...
    parent: Node
    children: Node
    def child_index(self, data: int | Any | None = ...) -> int: ...
    def child_position(self, child: Node) -> int: ...
    def children_foreach(
        self,
        flags: TraverseFlags,
        func: NodeForeachFunc[Unpack[_DataTs]],
        *data: Unpack[_DataTs],
    ) -> None: ...
    def depth(self) -> int: ...
    def destroy(self) -> None: ...
    ...
    def traverse(
        ...
        flags: TraverseFlags,
        max_depth: int,
        func: NodeTraverseFunc[Unpack[_DataTs]],
        *data: Unpack[_DataTs],
    ) -> None: ...
...
class Once(_gi.Struct):
    ...
    retval: int | Any | None
    @staticmethod
    def init_enter(location: int | Any | None) -> tuple[bool, int | Any | None]: ...
    @staticmethod
    def init_enter_impl(location: int) -> bool: ...
    @staticmethod
    def init_enter_pointer(location: int | Any | None) -> bool: ...
    @staticmethod
    def init_leave(location: int | Any | None, result: int) -> int | Any | None: ...
    @staticmethod
    def init_leave_pointer(
        location: int | Any | None, result: int | Any | None = ...
    ) -> None: ...
...
class OptionContext(_gi.Struct):
    ...
    def add_main_entries(
        self, entries: _Sequence[OptionEntry], translation_domain: str | None = ...
    ) -> None: ...
    def free(self) -> None: ...
    ...
    def parse(self, argv: _Sequence[str]) -> tuple[bool, list[str]]: ...
    def parse_strv(self, arguments: _Sequence[str]) -> tuple[bool, list[str]]: ...
    ...
    def set_translate_func(
        self, func: TranslateFunc[Unpack[_DataTs]] | None = ..., *data: Unpack[_DataTs]
    ) -> None: ...
...
class PathBuf(_gi.Struct):
    ...
    @staticmethod
    def equal(v1: int | Any | None, v2: int | Any | None) -> bool: ...
    def free(self) -> None: ...
    def free_to_path(self) -> str | None: ...
    def init(self) -> PathBuf: ...
    def init_from_path(self, path: str | None = ...) -> PathBuf: ...
    def pop(self) -> bool: ...
    def push(self, path: str) -> PathBuf: ...
    def set_extension(self, extension: str | None = ...) -> bool: ...
...
class PatternSpec(GObject.GBoxed):
    ...
    def free(self) -> None: ...
    def match(
        self, string_length: int, string: str, string_reversed: str | None = ...
    ) -> bool: ...
...
class Private(_gi.Struct):
    ...
    def p(self) -> int | Any | None: ...
    @property
    def notify(self) -> DestroyNotify: ...
    @property
    def future(self) -> list[int | Any | None]: ...
    def get(self) -> int | Any | None: ...
    def replace(self, value: int | Any | None = ...) -> None: ...
    def set(self, value: int | Any | None = ...) -> None: ...
...
class Queue(_gi.Struct):
    ...
    head: list[int | Any | None]
    tail: list[int | Any | None]
    length: int
    def clear(self) -> None: ...
    def clear_full(self, free_func: DestroyNotify | None = ...) -> None: ...
    def foreach(
        self, func: Func[Unpack[_DataTs]], *user_data: Unpack[_DataTs]
    ) -> None: ...
    def free(self) -> None: ...
    def free_full(self, free_func: DestroyNotify) -> None: ...
    def get_length(self) -> int: ...
    def index(self, data: int | Any | None = ...) -> int: ...
    def init(self) -> None: ...
    # override
    def insert_sorted(
        self,
        data: Any | None,
        func: CompareDataFunc[Any | None, Unpack[_DataTs]],
        *user_data: Unpack[_DataTs],
    ) -> None: ...
    def is_empty(self) -> bool: ...
    def peek_head(self) -> int | Any | None: ...
    def peek_nth(self, n: int) -> int | Any | None: ...
    def peek_tail(self) -> int | Any | None: ...
    def pop_head(self) -> int | Any | None: ...
    def pop_nth(self, n: int) -> int | Any | None: ...
    def pop_tail(self) -> int | Any | None: ...
    def push_head(self, data: int | Any | None = ...) -> None: ...
    def push_nth(self, data: int | Any | None, n: int) -> None: ...
    def push_tail(self, data: int | Any | None = ...) -> None: ...
    def remove(self, data: int | Any | None = ...) -> bool: ...
    def remove_all(self, data: int | Any | None = ...) -> int: ...
    def reverse(self) -> None: ...
    # override
    def sort(
        self,
        compare_func: CompareDataFunc[Any | None, Unpack[_DataTs]],
        *user_data: Unpack[_DataTs],
    ) -> None: ...
...
class Regex(GObject.GBoxed):
    ...
    def replace_eval(
        ...
        start_position: int,
        match_options: RegexMatchFlags,
        eval: RegexEvalCallback[Unpack[_DataTs]],
        *user_data: Unpack[_DataTs],
    ) -> str: ...
    def replace_literal(
        self,
...
class Relation(_gi.Struct):
    def count(self, key: int | Any | None, field: int) -> int: ...
    def delete(self, key: int | Any | None, field: int) -> int: ...
    def destroy(self) -> None: ...
    def print_(self) -> None: ...
...
class Scanner(_gi.Struct):
    ...
    next_position: int
    @property
    def symbol_table(self) -> dict[int | Any | None, int | Any | None]: ...
    @property
    ...
    def lookup_symbol(self, symbol: str) -> int | Any | None: ...
    def peek_next_token(self) -> TokenType: ...
    def scope_add_symbol(
        self, scope_id: int, symbol: str, value: int | Any | None = ...
    ) -> None: ...
    def scope_foreach_symbol(
        self, scope_id: int, func: HFunc[Unpack[_DataTs]], *user_data: Unpack[_DataTs]
    ) -> None: ...
    def scope_lookup_symbol(self, scope_id: int, symbol: str) -> int | Any | None: ...
...
class Sequence(_gi.Struct):
    def append(self, data: int | Any | None = ...) -> SequenceIter: ...
    def foreach(
        self, func: Func[Unpack[_DataTs]], *user_data: Unpack[_DataTs]
    ) -> None: ...
    @staticmethod
    ...
    def free(self) -> None: ...
    @staticmethod
    def get(iter: SequenceIter) -> int | Any | None: ...
    ...
    def insert_sorted(
        self,
        data: Any | None,
        cmp_func: CompareDataFunc[Any | None, Unpack[_DataTs]],
        *cmp_data: Unpack[_DataTs],
    ) -> SequenceIter: ...
    ...
    def prepend(self, data: int | Any | None = ...) -> SequenceIter: ...
    @staticmethod
    ...
    @staticmethod
    def set(iter: SequenceIter, data: int | Any | None = ...) -> None: ...
    # override
    def sort(
        self,
        cmp_func: CompareDataFunc[Any | None, Unpack[_DataTs]],
    ...
    def sort_iter(
        self,
        cmp_func: SequenceIterCompareFunc[Unpack[_DataTs]],
        *cmp_data: Unpack[_DataTs],
    ) -> None: ...
    @staticmethod
...
class Source(GObject.GBoxed):
    ...
    """
    @property
    def callback_data(self) -> int | Any | None: ...
    @property
    ...
    @property
    def poll_fds(self) -> list[int | Any | None]: ...
    @property
    ...
    def add_unix_fd(self, fd: int, events: IOCondition) -> int | Any | None: ...
    ...
    def modify_unix_fd(
        self, tag: int | Any | None, new_events: IOCondition
    ) -> None: ...
    @classmethod
    def new(cls, source_funcs: SourceFuncs, struct_size: int) -> Source: ...
    def query_unix_fd(self, tag: int | Any | None) -> IOCondition: ...
    def ref(self) -> Source: ...
    @staticmethod
    def remove(tag: int) -> bool: ...
    @staticmethod
    def remove_by_funcs_user_data(
        funcs: SourceFuncs, user_data: int | Any | None = ...
    ) -> bool: ...
    @staticmethod
    def remove_by_user_data(user_data: int | Any | None = ...) -> bool: ...
    def remove_child_source(self, child_source: Source) -> None: ...
    def remove_poll(self, fd: PollFD) -> None: ...
    def remove_unix_fd(self, tag: int | Any | None) -> None: ...
    def set_callback(self, func: Callable[..., bool], *user_data: Any) -> None: ...
    def set_callback_indirect(
        self, callback_data: int | Any | None, callback_funcs: SourceCallbackFuncs
    ) -> None: ...
...
class SourceCallbackFuncs(_gi.Struct):
    ...
    """
    @property
    def ref(self) -> Callable[[int | Any | None], None]: ...
    @property
    def unref(self) -> Callable[[int | Any | None], None]: ...
    @property
    def get(self) -> int | Any | None: ...
...
class SourceFuncs(_gi.Struct):
    ...
    dispatch: int | Any | None
    finalize: SourceFuncsFinalizeFunc
    @property
    def closure_callback(self) -> SourceFunc: ...
    @property
    def closure_marshal(self) -> SourceDummyMarshal: ...
...
class TestLogBuffer(_gi.Struct):
    ...
    @property
    def msgs(self) -> list[int | Any | None]: ...
    def free(self) -> None: ...
...
class Thread(GObject.GBoxed):
    ...
    @property
    def priority(self) -> int | Any | None: ...
    @staticmethod
    def error_quark() -> int: ...
    @staticmethod
    def exit(retval: int | Any | None = ...) -> None: ...
    def get_name(self) -> str: ...
    def join(self) -> int | Any | None: ...
    @classmethod
    def new(
        cls, name: str | None, func: ThreadFunc[Unpack[_DataTs]], *data: Unpack[_DataTs]
    ) -> Thread: ...
    def ref(self) -> Thread: ...
    @staticmethod
    def self() -> Thread: ...
...
class ThreadPool(_gi.Struct):
    ...
    def move_to_front(self, data: int | Any | None = ...) -> bool: ...
    def push(self, data: int | Any | None = ...) -> bool: ...
    @staticmethod
...
class TimeZone(GObject.GBoxed):
    ...
    def adjust_time(self, type: TimeType, time_: int) -> tuple[int, int]: ...
    ...
    @classmethod
    def new(cls, identifier: str | None = ...) -> TimeZone: ...
    @classmethod
    def new_identifier(cls, identifier: str | None = ...) -> TimeZone | None: ...
    @classmethod
...
class TrashStack(_gi.Struct):
    ...
    @staticmethod
    def peek(stack_p: TrashStack) -> int | Any | None: ...
    @staticmethod
    def pop(stack_p: TrashStack) -> int | Any | None: ...
    @staticmethod
    def push(stack_p: TrashStack, data_p: int | Any | None) -> None: ...
...
class Tree(GObject.GBoxed):
    ...
    def destroy(self) -> None: ...
    def foreach(
        self, func: TraverseFunc[Unpack[_DataTs]], *user_data: Unpack[_DataTs]
    ) -> None: ...
    def foreach_node(
        self, func: TraverseNodeFunc[Unpack[_DataTs]], *user_data: Unpack[_DataTs]
    ) -> None: ...
    def height(self) -> int: ...
    def insert(
        self, key: int | Any | None = ..., value: int | Any | None = ...
    ) -> None: ...
    def insert_node(
        self, key: int | Any | None = ..., value: int | Any | None = ...
    ) -> TreeNode | None: ...
    def lookup(self, key: int | Any | None = ...) -> int | Any | None: ...
    def lookup_extended(
        self, lookup_key: int | Any | None = ...
    ) -> tuple[bool, int | Any | None, int | Any | None]: ...
    def lookup_node(self, key: int | Any | None = ...) -> TreeNode | None: ...
    def lower_bound(self, key: int | Any | None = ...) -> TreeNode | None: ...
    # override
    @classmethod
    def new_full(
        cls,
        key_compare_func: CompareDataFunc[Any | None, Unpack[_DataTs]],
        key_destroy_func: DestroyNotify,
        *key_compare_data: Unpack[_DataTs],
    ) -> Tree: ...
    def nnodes(self) -> int: ...
    def node_first(self) -> TreeNode | None: ...
    def node_last(self) -> TreeNode | None: ...
    def ref(self) -> Tree: ...
    def remove(self, key: int | Any | None = ...) -> bool: ...
    ...
    def search(
        self,
        search_func: CompareDataFunc[Any | None, Unpack[_DataTs]],
        *user_data: Unpack[_DataTs],
    ) -> Any | None: ...
    # override
    def search_node(
    ...
    def steal(self, key: int | Any | None = ...) -> bool: ...
    def traverse(
        self,
        traverse_func: TraverseFunc[Unpack[_DataTs]],
        traverse_type: TraverseType,
        *user_data: Unpack[_DataTs],
    ) -> None: ...
    def unref(self) -> None: ...
    def upper_bound(self, key: int | Any | None = ...) -> TreeNode | None: ...

class TreeNode(_gi.Struct):
    def key(self) -> int | Any | None: ...
    def next(self) -> TreeNode | None: ...
    def previous(self) -> TreeNode | None: ...
    def value(self) -> int | Any | None: ...
...
class Tuples(_gi.Struct):
    ...
    len: int
    def destroy(self) -> None: ...
    def index(self, index_: int, field: int) -> int | Any | None: ...
...
class Uri(GObject.GBoxed):
    ...
    def split(
        ...
        str | None, str | None, str | None, int, str, str | None, str | None
    ]: ...
    @staticmethod
    def split_network(
        uri_string: str, flags: UriFlags
...
class Variant(_gi.Struct):
    ...
    def lookup_value(
        self, key: str, expected_type: VariantType | None = ...
    ) -> Variant: ...
    def n_children(self) -> int: ...
    @classmethod
    def new_array(
        cls,
        child_type: VariantType | None = ...,
        children: _Sequence[Variant] | None = ...,
    ) -> Variant: ...
    @classmethod
    ...
    @classmethod
    def new_maybe(
        cls, child_type: VariantType | None = ..., child: Variant | None = ...
    ) -> Variant: ...
    @classmethod
    ...
    def split_signature(klass, signature):
        ...
        """  # FIXME: Override is missing typing annotation
    def store(self, data: int | Any | None) -> None: ...
