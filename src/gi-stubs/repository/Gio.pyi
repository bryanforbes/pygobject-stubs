...
PropItemType = TypeVar("PropItemType", bound=GObject.Object, default=Any)
...
class ActionGroupInterface(GObject.GPointer):
    ...
    get_action_parameter_type: Callable[
        [ActionGroup, str], GLib.VariantType | None
    ] = ...
    get_action_state_type: Callable[[ActionGroup, str], GLib.VariantType | None] = ...
    get_action_state_hint: Callable[[ActionGroup, str], GLib.Variant | None] = ...
    get_action_state: Callable[[ActionGroup, str], GLib.Variant | None] = ...
    change_action_state: Callable[[ActionGroup, str, GLib.Variant], None] = ...
    activate_action: Callable[[ActionGroup, str, GLib.Variant | None], None] = ...
...
class ActionInterface(GObject.GPointer):
    ...
    get_parameter_type: Callable[[Action], GLib.VariantType | None] = ...
    get_state_type: Callable[[Action], GLib.VariantType | None] = ...
    get_state_hint: Callable[[Action], GLib.Variant | None] = ...
    get_enabled: Callable[[Action], bool] = ...
    get_state: Callable[[Action], GLib.Variant | None] = ...
    change_state: Callable[[Action, GLib.Variant], None] = ...
    activate: Callable[[Action, GLib.Variant | None], None] = ...
...
class ActionMapInterface(GObject.GPointer):
    ...
    g_iface: GObject.TypeInterface = ...
    lookup_action: Callable[[ActionMap, str], Action | None] = ...
...
class AppInfoIface(GObject.GPointer):
    ...
    get_id: Callable[[AppInfo], str | None] = ...
    get_name: Callable[[AppInfo], str] = ...
    get_description: Callable[[AppInfo], str | None] = ...
    get_executable: Callable[[AppInfo], str] = ...
    get_icon: Callable[[AppInfo], Icon | None] = ...
    launch: Callable[[AppInfo, list[File] | None, AppLaunchContext | None], bool] = ...
    supports_uris: Callable[[AppInfo], bool] = ...
    supports_files: Callable[[AppInfo], bool] = ...
    launch_uris: Callable[
        [AppInfo, list[str] | None, AppLaunchContext | None], bool
    ] = ...
    ...
    get_commandline: Callable[[AppInfo], str | None] = ...
...
class AppLaunchContextClass(GObject.GPointer):
    ...
    get_display: Callable[[AppLaunchContext, AppInfo, list[File]], str | None] = ...
    get_startup_notify_id: Callable[
        [AppLaunchContext, AppInfo | None, list[File] | None],
        str | None,
    ] = ...
...
class ApplicationCommandLineClass(GObject.GPointer):
    ...
    get_stdin: Callable[[ApplicationCommandLine], InputStream | None] = ...
    done: Callable[[ApplicationCommandLine], None] = ...
    padding: list[None] = ...
...
class AsyncResultIface(GObject.GPointer):
    ...
    get_source_object: Callable[[AsyncResult], GObject.Object | None] = ...
...
class BufferedInputStreamClass(GObject.GPointer):
    ...
    fill: Callable[[BufferedInputStream, int, Cancellable | None], int] = ...
...
class CancellableClass(GObject.GPointer):
    ...
    parent_class: GObject.ObjectClass = ...
    cancelled: Callable[[Cancellable | None], None] = ...
...
class DBusConnection(GObject.Object, AsyncInitable, Initable):
    ...
    def add_filter(
        self,
        filter_function: Callable[..., DBusMessage | None],
        *user_data: Any,
    ) -> int: ...
    def call(
        self,
...
class DBusInterfaceIface(GObject.GPointer):
    ...
    get_object: Callable[[DBusInterface], DBusObject | None] = ...
    set_object: Callable[[DBusInterface, DBusObject | None], None] = ...
    dup_object: Callable[[DBusInterface], DBusObject | None] = ...
...
class DBusObjectIface(GObject.GPointer):
    ...
    get_interface: Callable[[DBusObject, str], DBusInterface | None] = ...
...
class DBusObjectManagerIface(GObject.GPointer):
    ...
    get_object: Callable[[DBusObjectManager, str], DBusObject | None] = ...
    get_interface: Callable[[DBusObjectManager, str, str], DBusInterface | None] = ...
...
class DatagramBasedInterface(GObject.GPointer):
    ...
    condition_wait: Callable[
        [DatagramBased, GLib.IOCondition, int, Cancellable | None], bool
    ] = ...
...
class DriveIface(GObject.GPointer):
    ...
    get_identifier: Callable[[Drive, str], str | None] = ...
    ...
    get_sort_key: Callable[[Drive], str | None] = ...
...
class DtlsConnectionInterface(GObject.GPointer):
    ...
    handshake: Callable[[DtlsConnection, Cancellable | None], bool] = ...
    handshake_async: Callable[..., None] = ...
    handshake_finish: Callable[[DtlsConnection, AsyncResult], bool] = ...
    shutdown: Callable[[DtlsConnection, bool, bool, Cancellable | None], bool] = ...
    shutdown_async: Callable[..., None] = ...
    shutdown_finish: Callable[[DtlsConnection, AsyncResult], bool] = ...
    set_advertised_protocols: Callable[
        [DtlsConnection, Sequence[str] | None], None
    ] = ...
    get_negotiated_protocol: Callable[[DtlsConnection], str | None] = ...
...
class FileEnumeratorClass(GObject.GPointer):
    ...
    parent_class: GObject.ObjectClass = ...
    next_file: Callable[[FileEnumerator, Cancellable | None], FileInfo | None] = ...
    close_fn: Callable[[FileEnumerator, Cancellable | None], bool] = ...
...
class FileIOStreamClass(GObject.GPointer):
    ...
    seek: Callable[[FileIOStream, int, GLib.SeekType, Cancellable | None], bool] = ...
    can_truncate: Callable[[FileIOStream], bool] = ...
    truncate_fn: Callable[[FileIOStream, int, Cancellable | None], bool] = ...
    query_info: Callable[[FileIOStream, str, Cancellable | None], FileInfo] = ...
    query_info_async: Callable[..., None] = ...
    query_info_finish: Callable[[FileIOStream, AsyncResult], FileInfo] = ...
    get_etag: Callable[[FileIOStream], str | None] = ...
...
class FileIface(GObject.GPointer):
    ...
    get_uri_scheme: Callable[[File], str | None] = ...
    get_basename: Callable[[File], str | None] = ...
    get_path: Callable[[File], str | None] = ...
    get_uri: Callable[[File], str] = ...
    get_parse_name: Callable[[File], str] = ...
    get_parent: Callable[[File], File | None] = ...
    prefix_matches: Callable[[File, File], bool] = ...
    get_relative_path: Callable[[File, File], str | None] = ...
    ...
    query_settable_attributes: Callable[
        [File, Cancellable | None], FileAttributeInfoList
    ] = ...
    ...
    monitor_dir: Callable[
        [File, FileMonitorFlags, Cancellable | None], FileMonitor
    ] = ...
    monitor_file: Callable[
        [File, FileMonitorFlags, Cancellable | None], FileMonitor
    ] = ...
    open_readwrite: Callable[[File, Cancellable | None], FileIOStream] = ...
    open_readwrite_async: Callable[..., None] = ...
    open_readwrite_finish: Callable[[File, AsyncResult], FileIOStream] = ...
    create_readwrite: Callable[
        [File, FileCreateFlags, Cancellable | None], FileIOStream
    ] = ...
...
class FileInputStreamClass(GObject.GPointer):
    ...
    seek: Callable[
        [FileInputStream, int, GLib.SeekType, Cancellable | None], bool
    ] = ...
    query_info: Callable[[FileInputStream, str, Cancellable | None], FileInfo] = ...
    query_info_async: Callable[..., None] = ...
...
class FileOutputStreamClass(GObject.GPointer):
    ...
    seek: Callable[
        [FileOutputStream, int, GLib.SeekType, Cancellable | None], bool
    ] = ...
    can_truncate: Callable[[FileOutputStream], bool] = ...
    truncate_fn: Callable[[FileOutputStream, int, Cancellable | None], bool] = ...
    query_info: Callable[[FileOutputStream, str, Cancellable | None], FileInfo] = ...
    query_info_async: Callable[..., None] = ...
    query_info_finish: Callable[[FileOutputStream, AsyncResult], FileInfo] = ...
    get_etag: Callable[[FileOutputStream], str | None] = ...
...
class IOStreamClass(GObject.GPointer):
    ...
    close_fn: Callable[[IOStream, Cancellable | None], bool] = ...
    close_async: Callable[..., None] = ...
...
class IconIface(GObject.GPointer):
    ...
    equal: Callable[[Icon | None, Icon | None], bool] = ...
    to_tokens: Callable[[Icon], tuple[bool, list[str], int]] = ...
    from_tokens: None = ...
    serialize: Callable[[Icon], GLib.Variant | None] = ...
...
class InitableIface(GObject.GPointer):
    ...
    g_iface: GObject.TypeInterface = ...
    init: Callable[[Initable, Cancellable | None], bool] = ...
...
class InputStreamClass(GObject.GPointer):
    ...
    parent_class: GObject.ObjectClass = ...
    read_fn: Callable[[InputStream, None, int, Cancellable | None], int] = ...
    skip: Callable[[InputStream, int, Cancellable | None], int] = ...
    close_fn: Callable[[InputStream, Cancellable | None], bool] = ...
...
class ListModelInterface(GObject.GPointer):
    ...
    g_iface: GObject.TypeInterface = ...
    get_item_type: Callable[[ListModel], type[Any]] = ...
    get_n_items: Callable[[ListModel], int] = ...
    get_item: Callable[[ListModel, int], GObject.Object | None] = ...
...
class ListStore(GObject.Object, ListModel[ObjectItemType], Generic[ObjectItemType]):
    ...
    Signals from GObject:
      notify (GParam)
    """
    class Props(GObject.Object.Props, Generic[PropItemType]):
        item_type: type[PropItemType]
        n_items: int

    @property
    def props(self) -> Props[ObjectItemType]: ...
    @overload
    def __init__(self: ListStore[GObject.Object]) -> None: ...
    @overload
...
class LoadableIconIface(GObject.GPointer):
    ...
    g_iface: GObject.TypeInterface = ...
    load: Callable[
        [LoadableIcon, int, Cancellable | None],
        tuple[InputStream, str],
    ] = ...
...
class MountIface(GObject.GPointer):
    ...
    get_uuid: Callable[[Mount], str | None] = ...
    get_volume: Callable[[Mount], Volume | None] = ...
    get_drive: Callable[[Mount], Drive | None] = ...
    ...
    guess_content_type_sync: Callable[
        [Mount, bool, Cancellable | None], list[str]
    ] = ...
    ...
    get_sort_key: Callable[[Mount], str | None] = ...
...
class NetworkMonitorInterface(GObject.GPointer):
    ...
    can_reach: Callable[
        [NetworkMonitor, SocketConnectable, Cancellable | None], bool
    ] = ...
...
class OutputStreamClass(GObject.GPointer):
    ...
    flush: Callable[[OutputStream, Cancellable | None], bool] = ...
    close_fn: Callable[[OutputStream, Cancellable | None], bool] = ...
    ...
    writev_fn: Callable[
        [OutputStream, Sequence[OutputVector], Cancellable | None],
        tuple[bool, int],
    ] = ...
...
class PermissionClass(GObject.GPointer):
    ...
    parent_class: GObject.ObjectClass = ...
    acquire: Callable[[Permission, Cancellable | None], bool] = ...
    acquire_async: Callable[..., None] = ...
    acquire_finish: Callable[[Permission, AsyncResult], bool] = ...
    release: Callable[[Permission, Cancellable | None], bool] = ...
...
class PollableInputStreamInterface(GObject.GPointer):
    ...
    create_source: Callable[
        [PollableInputStream, Cancellable | None], GLib.Source
    ] = ...
...
class PollableOutputStreamInterface(GObject.GPointer):
    ...
    create_source: Callable[
        [PollableOutputStream, Cancellable | None], GLib.Source
    ] = ...
    write_nonblocking: Callable[[PollableOutputStream, Sequence[int] | None], int] = ...
    writev_nonblocking: Callable[
        [PollableOutputStream, Sequence[OutputVector]],
        tuple[PollableReturn, int],
    ] = ...
...
class ProxyInterface(GObject.GPointer):
    ...
    g_iface: GObject.TypeInterface = ...
    connect: Callable[
        [Proxy, IOStream, ProxyAddress, Cancellable | None], IOStream
    ] = ...
...
class ProxyResolverInterface(GObject.GPointer):
    ...
    lookup: Callable[[ProxyResolver, str, Cancellable | None], list[str]] = ...
...
class ResolverClass(GObject.GPointer):
    ...
    lookup_by_name: Callable[
        [Resolver, str, Cancellable | None], list[InetAddress]
    ] = ...
    lookup_by_name_async: Callable[..., None] = ...
    lookup_by_name_finish: Callable[[Resolver, AsyncResult], list[InetAddress]] = ...
    lookup_by_address: Callable[[Resolver, InetAddress, Cancellable | None], str] = ...
    ...
    lookup_records: Callable[
        [Resolver, str, ResolverRecordType, Cancellable | None],
        list[GLib.Variant],
    ] = ...
    ...
    lookup_by_name_with_flags: Callable[
        [Resolver, str, ResolverNameLookupFlags, Cancellable | None],
        list[InetAddress],
    ] = ...
...
class SeekableIface(GObject.GPointer):
    ...
    seek: Callable[[Seekable, int, GLib.SeekType, Cancellable | None], bool] = ...
    can_truncate: Callable[[Seekable], bool] = ...
    truncate_fn: Callable[[Seekable, int, Cancellable | None], bool] = ...
...
class Settings(GObject.Object):
    ...
    def get_mapped(
        self,
        key: str,
        mapping: Callable[..., tuple[bool, None]],
        *user_data: Any,
    ) -> None: ...
...
class SettingsBackend(GObject.Object):
    ...
    def flatten_tree(
        tree: GLib.Tree,
    ) -> tuple[str, list[str], list[GLib.Variant]]: ...
    @staticmethod
...
class SocketAddressEnumeratorClass(GObject.GPointer):
    ...
    parent_class: GObject.ObjectClass = ...
    next: Callable[
        [SocketAddressEnumerator, Cancellable | None],
        SocketAddress | None,
    ] = ...
    next_async: Callable[..., None] = ...
    next_finish: Callable[
        [SocketAddressEnumerator, AsyncResult], SocketAddress | None
    ] = ...
...
class Task(GObject.Object, AsyncResult):
    ...
    def return_pointer(
        self,
        result: None,
        result_destroy: Callable[[None], None] | None = None,
    ) -> None: ...
    ...
    def set_task_data(
        self,
        task_data: None,
        task_data_destroy: Callable[[None], None] | None = None,
    ) -> None: ...
...
class TlsBackendInterface(GObject.GPointer):
    ...
    get_certificate_type: Callable[[], type[Any]] = ...
    get_client_connection_type: Callable[[], type[Any]] = ...
    get_server_connection_type: Callable[[], type[Any]] = ...
    get_file_database_type: Callable[[], type[Any]] = ...
    get_default_database: Callable[[TlsBackend], TlsDatabase] = ...
    supports_dtls: Callable[[TlsBackend], bool] = ...
    get_dtls_client_connection_type: Callable[[], type[Any]] = ...
    get_dtls_server_connection_type: Callable[[], type[Any]] = ...
...
class TlsConnectionClass(GObject.GPointer):
    ...
    handshake: Callable[[TlsConnection, Cancellable | None], bool] = ...
    handshake_async: Callable[..., None] = ...
    handshake_finish: Callable[[TlsConnection, AsyncResult], bool] = ...
    get_binding_data: Callable[
        [TlsConnection, TlsChannelBindingType, Sequence[int]], bool
    ] = ...
    get_negotiated_protocol: Callable[[TlsConnection], str | None] = ...
    padding: list[None] = ...
...
class TlsDatabaseClass(GObject.GPointer):
    ...
    create_certificate_handle: Callable[[TlsDatabase, TlsCertificate], str | None] = ...
...
class TlsInteractionClass(GObject.GPointer):
    ...
    parent_class: GObject.ObjectClass = ...
    ask_password: Callable[
        [TlsInteraction, TlsPassword, Cancellable | None],
        TlsInteractionResult,
    ] = ...
...
class VolumeIface(GObject.GPointer):
    ...
    get_uuid: Callable[[Volume], str | None] = ...
    get_drive: Callable[[Volume], Drive | None] = ...
    get_mount: Callable[[Volume], Mount | None] = ...
...
class VolumeMonitorClass(GObject.GPointer):
    ...
    get_volume_for_uuid: Callable[[VolumeMonitor, str], Volume | None] = ...
    get_mount_for_uuid: Callable[[VolumeMonitor, str], Mount | None] = ...
