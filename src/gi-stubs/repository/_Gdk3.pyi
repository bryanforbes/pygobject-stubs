...
EventFunc: TypeAlias = Callable[[Event, Unpack[_DataTs]], None]
FilterFunc: TypeAlias = Callable[[Any, Event, Unpack[_DataTs]], FilterReturn]
SeatGrabPrepareFunc: TypeAlias = Callable[[Seat, Window, Unpack[_DataTs]], None]
WindowChildFunc: TypeAlias = Callable[[Window, Unpack[_DataTs]], bool]
WindowInvalidateHandlerFunc: TypeAlias = Callable[[Window, cairo.Region], None]
...
def event_handler_set(
    func: EventFunc[Unpack[_DataTs]], *data: Unpack[_DataTs]
) -> None: ...
...
def init(argv: Sequence[str]) -> list[str]: ...
def init_check(argv: Sequence[str]) -> tuple[bool, list[str]]: ...
...
def parse_args(argv: Sequence[str]) -> list[str]: ...
...
def threads_add_idle(
    priority: int, function: GLib.SourceFunc[Unpack[_DataTs]], *data: Unpack[_DataTs]
) -> int: ...
def threads_add_timeout(
    priority: int,
    interval: int,
    function: GLib.SourceFunc[Unpack[_DataTs]],
    *data: Unpack[_DataTs],
) -> int: ...
...
class Display(GObject.Object):
    ...
    def store_clipboard(
        self, clipboard_window: Window, time_: int, targets: Sequence[Atom] | None = ...
    ) -> None: ...
...
class Screen(GObject.Object):
    ...
    @type_check_only
    class Props(GObject.Object.Props):
        font_options: int | Any | None
        resolution: float

    @property
    def props(self) -> Props: ...
    def __init__(
        self, *, font_options: int | Any | None = ..., resolution: float = ...
    ) -> None: ...
...
class Seat(GObject.Object):
    ...
    def grab(
        ...
        cursor: Cursor | None = ...,
        event: Event | None = ...,
        prepare_func: SeatGrabPrepareFunc[Unpack[_DataTs]] | None = ...,
        *prepare_func_data: Unpack[_DataTs],
    ) -> GrabStatus: ...
...
class Window(GObject.Object):
    ...
    def get_children_with_user_data(
        self, user_data: int | Any | None = ...
    ) -> list[Window]: ...
    ...
    def invalidate_maybe_recurse(
        self,
        region: cairo.Region,
        child_func: WindowChildFunc[Unpack[_DataTs]] | None = ...,
    ...
    def set_background_pattern(self, pattern: cairo.Pattern | None = ...) -> None: ...
    ...
    def set_group(self, leader: Window | None = ...) -> None: ...
    ...
    def set_user_data(self, user_data: GObject.Object | None = ...) -> None: ...
...
class WindowClass(_gi.Struct):
    ...
    @property
    def pick_embedded_child(self) -> int | Any | None: ...
    @property
