...
class FontClass(GObject.GPointer):
    ...
    get_glyph_extents: Callable[[Font | None, int], tuple[Rectangle, Rectangle]]
    get_metrics: Callable[[Font | None, Language | None], FontMetrics]
    get_font_map: Callable[[Font | None], FontMap | None]
...
class FontFamilyClass(GObject.GPointer):
    ...
    get_face: Callable[[FontFamily, str | None], FontFace | None]
...
class FontMapClass(GObject.GPointer):
    ...
    parent_class: GObject.ObjectClass
    load_font: Callable[[FontMap, Context, FontDescription], Font | None]
    list_families: Callable[[FontMap], list[FontFamily]]
    load_fontset: Callable[
        [FontMap, Context, FontDescription, Language], Fontset | None
    ]
...
class RendererClass(GObject.GPointer):
    ...
    draw_glyph_item: Callable[[Renderer, str | None, GlyphItem, int, int], None]
