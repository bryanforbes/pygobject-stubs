...
AttrDataCopyFunc: TypeAlias = Callable[[Unpack[_DataTs]], Any | None]
AttrFilterFunc: TypeAlias = Callable[[Attribute, Unpack[_DataTs]], bool]
FontsetForeachFunc: TypeAlias = Callable[[Fontset, Font, Unpack[_DataTs]], bool]
...
def attr_shape_new_with_data(
    ...
    data: int | Any | None = ...,
    copy_func: AttrDataCopyFunc | None = ...,
) -> Attribute: ...
...
def default_break(
    text: str, length: int, analysis: Analysis | None = ...
) -> list[LogAttr]: ...
...
class Analysis(_gi.Struct):
    ...
    shape_engine: int | Any | None
    lang_engine: int | Any | None
    font: Font
    level: int
    gravity: int
    flags: int
...
class AttrList(GObject.GBoxed):
    ...
    def filter(
        self, func: AttrFilterFunc[Unpack[_DataTs]], *data: Unpack[_DataTs]
    ) -> AttrList | None: ...
    @staticmethod
...
class Context(GObject.Object):
    ...
    def get_metrics(
        self, desc: FontDescription | None = ..., language: Language | None = ...
    ) -> FontMetrics: ...
...
class Font(GObject.Object):
    ...
    @staticmethod
    def descriptions_free(descs: Sequence[FontDescription] | None = ...) -> None: ...
    @staticmethod
...
class FontDescription(GObject.GBoxed):
    ...
    def set_features(self, features: str | None = ...) -> None: ...
    ...
    def set_variations(self, variations: str | None = ...) -> None: ...
...
class FontFaceClass(_gi.Struct):
    ...
    @property
    def list_sizes(self) -> Callable[[FontFace], tuple[list[int] | None, int]]: ...
    @property
...
class FontMapClass(_gi.Struct):
    ...
    @property
    def get_face(self) -> int | Any | None: ...
...
class Fontset(GObject.Object):
    ...
    def parent_instance(self) -> GObject.Object: ...
    def do_foreach(
        self, func: FontsetForeachFunc[Unpack[_DataTs]], *data: Unpack[_DataTs]
    ) -> None: ...
...
class FontsetClass(_gi.Struct):
    ...
    def foreach(
        self,
    ) -> Callable[[Fontset, FontsetForeachFunc, int | Any | None], None]: ...
...
class Language(GObject.GBoxed):
    @staticmethod
    def from_string(language: str | None = ...) -> Language | None: ...
    @staticmethod
...
class Gravity(GObject.GEnum):
    ...
    WEST = 3
    @staticmethod
    def get_for_matrix(matrix: Matrix | None = ...) -> Gravity: ...
    @staticmethod
    def get_for_script(
        script: Script, base_gravity: Gravity, hint: GravityHint
    ) -> Gravity: ...
