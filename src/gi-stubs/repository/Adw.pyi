...
AnimationTargetFunc: TypeAlias = Callable[[float, Unpack[_DataTs]], None]
...
def length_unit_from_px(
    unit: LengthUnit, value: float, settings: _Gtk4.Settings | None = ...
) -> float: ...
...
class AboutDialog(Dialog):
    ...
    def set_designers(self, designers: Sequence[str] | None = ...) -> None: ...
    def set_developer_name(self, developer_name: str) -> None: ...
    def set_developers(self, developers: Sequence[str] | None = ...) -> None: ...
    def set_documenters(self, documenters: Sequence[str] | None = ...) -> None: ...
...
class ActionRow(PreferencesRow):
    ...
    def set_activatable_widget(self, widget: _Gtk4.Widget | None = ...) -> None: ...
...
class AlertDialog(Dialog):
    ...
    def choose(
        ...
        callback: Gio.AsyncReadyCallback[Unpack[_DataTs]] | None = ...,
    ...
    @classmethod
    def new(cls, heading: str | None = ..., body: str | None = ...) -> AlertDialog: ...
    ...
    def set_extra_child(self, child: _Gtk4.Widget | None = ...) -> None: ...
...
class ApplicationWindow(_Gtk4.ApplicationWindow):
    ...
    def set_content(self, content: _Gtk4.Widget | None = ...) -> None: ...
...
class Avatar(_Gtk4.Widget):
    ...
    def set_custom_image(self, custom_image: _Gdk4.Paintable | None = ...) -> None: ...
    def set_icon_name(self, icon_name: str | None = ...) -> None: ...
...
class Bin(_Gtk4.Widget):
    ...
    @classmethod
    def new(cls) -> Bin: ...
    def set_child(self, child: _Gtk4.Widget | None = ...) -> None: ...
...
class BottomSheet(_Gtk4.Widget, Swipeable):
    ...
    def set_bottom_bar(self, bottom_bar: _Gtk4.Widget | None = ...) -> None: ...
    ...
    def set_sheet(self, sheet: _Gtk4.Widget | None = ...) -> None: ...
...
class Breakpoint(GObject.Object, _Gtk4.Buildable):
    ...
    def add_setter(
        self, object: GObject.Object, property: str, value: Any | None = ...
    ) -> None: ...
    def add_setters(
        self,
...
class CallbackAnimationTarget(AnimationTarget):
    ...
    """
    @classmethod
    def new(cls, callback: AnimationTargetFunc) -> CallbackAnimationTarget: ...
...
class ComboRow(ActionRow):
    ...
    def set_expression(self, expression: _Gtk4.Expression | None = ...) -> None: ...
    def set_factory(self, factory: _Gtk4.ListItemFactory | None = ...) -> None: ...
    def set_header_factory(
        self, factory: _Gtk4.ListItemFactory | None = ...
    ) -> None: ...
    def set_list_factory(self, factory: _Gtk4.ListItemFactory | None = ...) -> None: ...
...
class Dialog(_Gtk4.Widget, _Gtk4.ShortcutManager):
    ...
    @classmethod
    def new(cls) -> Dialog: ...
    def present(self, parent: _Gtk4.Widget | None = ...) -> None: ...
    def set_can_close(self, can_close: bool) -> None: ...
    def set_child(self, child: _Gtk4.Widget | None = ...) -> None: ...
    def set_content_height(self, content_height: int) -> None: ...
    def set_content_width(self, content_width: int) -> None: ...
    def set_default_widget(self, default_widget: _Gtk4.Widget | None = ...) -> None: ...
    def set_focus(self, focus: _Gtk4.Widget | None = ...) -> None: ...
...
class Flap(_Gtk4.Widget, Swipeable, _Gtk4.Orientable):
    ...
    def new(cls) -> Flap: ...
    def set_content(self, content: _Gtk4.Widget | None = ...) -> None: ...
    def set_flap(self, flap: _Gtk4.Widget | None = ...) -> None: ...
    ...
    def set_separator(self, separator: _Gtk4.Widget | None = ...) -> None: ...
...
class HeaderBar(_Gtk4.Widget):
    ...
    def set_title_widget(self, title_widget: _Gtk4.Widget | None = ...) -> None: ...
...
class OverlaySplitView(_Gtk4.Widget, Swipeable):
    ...
    def set_sidebar(self, sidebar: _Gtk4.Widget | None = ...) -> None: ...
    def set_sidebar_position(self, position: _Gtk4.PackType) -> None: ...
    def set_sidebar_width_fraction(self, fraction: float) -> None: ...
    def set_sidebar_width_unit(self, unit: LengthUnit) -> None: ...
...
class PreferencesGroup(_Gtk4.Widget):
    ...
    def bind_model(
        self,
        model: Gio.ListModel | None = ...,
        create_row_func: _Gtk4.ListBoxCreateWidgetFunc[Unpack[_DataTs]] | None = ...,
        *user_data: Unpack[_DataTs],
    ) -> None: ...
    ...
    def set_header_suffix(self, suffix: _Gtk4.Widget | None = ...) -> None: ...
...
class ShortcutsSection(GObject.Object, Gio.ListModel, _Gtk4.Buildable):
    ...
    @classmethod
    def new(cls, title: str | None = ...) -> ShortcutsSection: ...
...
class SpinRow(ActionRow, _Gtk4.Editable):
    ...
    def set_adjustment(self, adjustment: _Gtk4.Adjustment | None = ...) -> None: ...
...
class SpinnerPaintable(GObject.Object, _Gdk4.Paintable, _Gtk4.SymbolicPaintable):
    ...
    @classmethod
    def new(cls, widget: _Gtk4.Widget | None = ...) -> SpinnerPaintable: ...
    def set_widget(self, widget: _Gtk4.Widget | None = ...) -> None: ...
...
class SplitButton(_Gtk4.Widget, _Gtk4.Actionable):
    ...
    def set_popover(self, popover: _Gtk4.Popover | None = ...) -> None: ...
    def set_use_underline(self, use_underline: bool) -> None: ...
...
class StatusPage(_Gtk4.Widget):
    ...
    def set_description(self, description: str | None = ...) -> None: ...
    def set_icon_name(self, icon_name: str | None = ...) -> None: ...
    def set_paintable(self, paintable: _Gdk4.Paintable | None = ...) -> None: ...
    def set_title(self, title: str) -> None: ...
...
class TabBar(_Gtk4.Widget):
    ...
    def set_end_action_widget(self, widget: _Gtk4.Widget | None = ...) -> None: ...
    def set_expand_tabs(self, expand_tabs: bool) -> None: ...
    def set_extra_drag_preload(self, preload: bool) -> None: ...
    def set_inverted(self, inverted: bool) -> None: ...
    def set_start_action_widget(self, widget: _Gtk4.Widget | None = ...) -> None: ...
    def set_view(self, view: TabView | None = ...) -> None: ...
    def setup_extra_drop_target(
        self, actions: _Gdk4.DragAction, types: Sequence[type[Any]] | None = ...
    ) -> None: ...
...
class TabOverview(_Gtk4.Widget):
    ...
    def set_secondary_menu(
        self, secondary_menu: Gio.MenuModel | None = ...
    ) -> None: ...
...
class TabView(_Gtk4.Widget):
    ...
    def add_page(
        self, child: _Gtk4.Widget, parent: TabPage | None = ...
    ) -> TabPage: ...
...
class Toast(GObject.Object):
    ...
    def set_action_target_value(
        self, action_target: GLib.Variant | None = ...
    ) -> None: ...
    def set_button_label(self, button_label: str | None = ...) -> None: ...
    def set_custom_title(self, widget: _Gtk4.Widget | None = ...) -> None: ...
    def set_detailed_action_name(
        self, detailed_action_name: str | None = ...
    ) -> None: ...
...
class ViewStack(_Gtk4.Widget):
    ...
    def add_named(
        self, child: _Gtk4.Widget, name: str | None = ...
    ) -> ViewStackPage: ...
    def add_titled(
