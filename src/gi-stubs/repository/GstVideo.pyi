...
VideoAffineTransformationGetMatrix: TypeAlias = Callable[
    [VideoAffineTransformationMeta, float], bool
]
VideoConvertSampleCallback: TypeAlias = Callable[
    [Gst.Sample, GLib.GError, Unpack[_DataTs]], None
]
VideoFormatPack: TypeAlias = Callable[
    [VideoFormatInfo, VideoPackFlags, Any, int, Any, int, VideoChromaSite, int, int],
    None,
]
VideoFormatUnpack: TypeAlias = Callable[
    [VideoFormatInfo, VideoPackFlags, Any, Any, int, int, int, int], None
]
# override
VideoGLTextureUpload: TypeAlias = Callable[
    [VideoGLTextureUploadMeta, int, Unpack[_DataTs]], bool
]
...
def buffer_add_video_gl_texture_upload_meta(
    ...
    upload: VideoGLTextureUpload[Unpack[_DataTs]],
...
def buffer_add_video_overlay_composition_meta(
    buf: Gst.Buffer, comp: VideoOverlayComposition | None = ...
...
def buffer_add_video_sei_user_data_unregistered_meta(
    buffer: Gst.Buffer, uuid: Sequence[int], data: Sequence[int] | None = ...
...
def video_convert_sample_async(
    ...
    to_caps: Gst.Caps,
    timeout: int,
    callback: VideoConvertSampleCallback[Unpack[_DataTs]],
    *user_data: Unpack[_DataTs],
) -> None: ...
...
def video_format_get_palette(format: VideoFormat) -> tuple[int | Any | None, int]: ...
...
def video_make_raw_caps(formats: Sequence[VideoFormat] | None = ...) -> Gst.Caps: ...
def video_make_raw_caps_with_features(
    formats: Sequence[VideoFormat] | None = ..., features: Gst.CapsFeatures | None = ...
) -> Gst.Caps: ...
...
class VideoCodecFrame(GObject.GBoxed):
    ...
    deadline: int
    @property
    def events(self) -> list[int | Any | None]: ...
    @property
    def user_data(self) -> int | Any | None: ...
    @property
...
class VideoDecoder(Gst.Element):
    ...
    def proxy_getcaps(
        self, caps: Gst.Caps | None = ..., filter: Gst.Caps | None = ...
    ) -> Gst.Caps: ...
    ...
    def set_interlaced_output_state(
        ...
        width: int,
        height: int,
        reference: VideoCodecState | None = ...,
...
class VideoEncoder(Gst.Element, Gst.Preset):
    ...
    def set_output_state(
        self, caps: Gst.Caps, reference: VideoCodecState | None = ...
    ) -> VideoCodecState | None: ...
...
class VideoOverlayComposition(GObject.GBoxed):
    ...
    @classmethod
    def new(
        cls, rectangle: VideoOverlayRectangle | None = ...
...
class VideoVBIEncoder(GObject.GBoxed):
    ...
    """
    def __init__(self, format: VideoFormat, pixel_width: int) -> None: ...
    def add_ancillary(
...
class VideoFormat(GObject.GEnum):
    ...
    @staticmethod
    def get_palette(format: VideoFormat) -> tuple[int | Any | None, int]: ...
    @staticmethod
