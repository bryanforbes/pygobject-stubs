...
class GutterRendererClass(GObject.GPointer):
    ...
    snapshot_line: Callable[[GutterRenderer, _Gtk4.Snapshot, GutterLines, int], None]
    ...
    query_activatable: Callable[[GutterRenderer, _Gtk4.TextIter, _Gdk4.Rectangle], bool]
    activate: Callable[
