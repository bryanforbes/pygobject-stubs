...
AudioBaseSinkCustomSlavingCallback: TypeAlias = Callable[
    [AudioBaseSink, int, int, int, AudioBaseSinkDiscontReason, Unpack[_DataTs]], None
]
AudioClockGetTimeFunc: TypeAlias = Callable[[Gst.Clock, Unpack[_DataTs]], int]
AudioFormatPack: TypeAlias = Callable[
    [AudioFormatInfo, AudioPackFlags, list[int], list[int], int], None
]
AudioFormatUnpack: TypeAlias = Callable[
    [AudioFormatInfo, AudioPackFlags, list[int], list[int], int], None
]
AudioRingBufferCallback: TypeAlias = Callable[
    [AudioRingBuffer, list[int], Unpack[_DataTs]], None
]
...
def buffer_add_dsd_plane_offset_meta(
    buffer: Gst.Buffer, num_bytes_per_channel: int, offsets: Sequence[int] | None = ...
) -> DsdPlaneOffsetMeta: ...
...
class AudioBaseSink(GstBase.BaseSink):
    ...
    def set_custom_slaving_callback(
        self,
        callback: AudioBaseSinkCustomSlavingCallback[Unpack[_DataTs]],
...
class AudioBuffer(_gi.Struct):
    ...
    @property
    def priv_planes_arr(self) -> list[int | Any | None]: ...
    @property
...
class AudioClock(Gst.SystemClock):
    ...
    def new(
        cls,
        name: str,
        func: AudioClockGetTimeFunc[Unpack[_DataTs]],
        *user_data: Unpack[_DataTs],
    ) -> AudioClock: ...
...
class AudioConverter(GObject.GBoxed):
    ...
    def update_config(
        self, in_rate: int, out_rate: int, config: Gst.Structure | None = ...
    ) -> bool: ...
...
class AudioInfo(GObject.GBoxed):
    ...
    def set_format(
        ...
        rate: int,
        channels: int,
        position: Sequence[AudioChannelPosition] | None = ...,
    ) -> None: ...
...
class AudioRingBuffer(Gst.Object):
    ...
    def set_callback(
        self,
        cb: AudioRingBufferCallback[Unpack[_DataTs]] | None = ...,
        *user_data: Unpack[_DataTs],
    ) -> None: ...
...
class AudioRingBufferClass(_gi.Struct):
    ...
    def commit(
        ...
        [AudioRingBuffer, int, Sequence[int], int, int, int], tuple[int, int, int]
    ]: ...
    @property
...
class AudioSinkClass(_gi.Struct):
    ...
    @property
    def write(self) -> Callable[[AudioSink, Sequence[int], int], int]: ...
    @property
...
class AudioSrcClass(_gi.Struct):
    ...
    @property
    def read(self) -> Callable[[AudioSrc, Sequence[int], int], tuple[int, int]]: ...
    @property
...
class DsdInfo(GObject.GBoxed):
    ...
    def set_format(
        ...
        rate: int,
        channels: int,
        positions: Sequence[AudioChannelPosition] | None = ...,
    ) -> None: ...
    def to_caps(self) -> Gst.Caps: ...
