...
class AudioBaseSinkClass(GObject.GPointer):
    ...
    create_ringbuffer: Callable[[AudioBaseSink], AudioRingBuffer | None] = ...
...
class AudioBaseSrcClass(GObject.GPointer):
    ...
    create_ringbuffer: Callable[[AudioBaseSrc], AudioRingBuffer | None] = ...
...
class AudioDecoderClass(GObject.GPointer):
    ...
    parse: Callable[
        [AudioDecoder, GstBase.Adapter], tuple[Gst.FlowReturn, int, int]
    ] = ...
