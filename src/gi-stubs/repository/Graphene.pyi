...
class Plane(GObject.GBoxed):
    ...
    def transform(
        self, matrix: Matrix, normal_matrix: Matrix | None = ...
    ) -> Plane: ...
...
class Ray(GObject.GBoxed):
    ...
    def init(
        self, origin: Point3D | None = ..., direction: Vec3 | None = ...
    ) -> Ray: ...
    def init_from_ray(self, src: Ray) -> Ray: ...
    def init_from_vec3(
        self, origin: Vec3 | None = ..., direction: Vec3 | None = ...
    ) -> Ray: ...
...
class Sphere(GObject.GBoxed):
    ...
    def init_from_points(
        self, points: Sequence[Point3D], center: Point3D | None = ...
    ) -> Sphere: ...
    def init_from_vectors(
        self, vectors: Sequence[Vec3], center: Point3D | None = ...
    ) -> Sphere: ...
...
class Triangle(GObject.GBoxed):
    ...
    def init_from_point3d(
        self, a: Point3D | None = ..., b: Point3D | None = ..., c: Point3D | None = ...
    ) -> Triangle: ...
    def init_from_vec3(
        self, a: Vec3 | None = ..., b: Vec3 | None = ..., c: Vec3 | None = ...
    ) -> Triangle: ...
