...
def categories_register_change_listener(
    listener: Callable[..., None], *user_data: Any
) -> None: ...
...
def debug_log_disable_domains(domains: Sequence[str]) -> None: ...
def debug_log_dump(filename: str) -> bool: ...
def debug_log_dump_to_dated_file() -> bool: ...
def debug_log_enable_domains(domains: Sequence[str]) -> None: ...
...
def enum_from_string(enum_type: type[Any], string: str, enum_value: int) -> bool: ...
def enum_to_string(enum_type: type[Any], enum_value: int) -> str: ...
...
def file_recursive_delete_sync(
    file: Gio.File, cancellable: Gio.Cancellable | None = None
) -> bool: ...
def filename_make_safe(string: str) -> None: ...
def filename_mkdir_encoded(
    basepath: str, fileprefix: str, filename: str | None, fileindex: int
) -> str | None: ...
...
def gdata_task_add_notes(builder: Json.Builder, value: str | None = None) -> None: ...
...
def gdata_task_get_etag(task: Json.Object) -> str | None: ...
def gdata_task_get_hidden(task: Json.Object) -> bool: ...
def gdata_task_get_id(task: Json.Object) -> str | None: ...
def gdata_task_get_notes(task: Json.Object) -> str | None: ...
def gdata_task_get_parent(task: Json.Object) -> str | None: ...
def gdata_task_get_position(task: Json.Object) -> str | None: ...
def gdata_task_get_self_link(task: Json.Object) -> str | None: ...
def gdata_task_get_status(task: Json.Object) -> GDataTaskStatus: ...
def gdata_task_get_title(task: Json.Object) -> str | None: ...
...
def gdata_tasklist_get_etag(tasklist: Json.Object) -> str | None: ...
def gdata_tasklist_get_id(tasklist: Json.Object) -> str | None: ...
def gdata_tasklist_get_self_link(tasklist: Json.Object) -> str | None: ...
def gdata_tasklist_get_title(tasklist: Json.Object) -> str | None: ...
...
def oauth2_service_util_set_to_form(
    form: dict[str, str], name: str, value: str | None = None
) -> None: ...
...
def secret_store_delete_sync(
    uid: str, cancellable: Gio.Cancellable | None = None
) -> bool: ...
...
) -> tuple[TimeParseStatus, None, bool]: ...
...
def util_copy_object_slist(
    copy_to: list[GObject.Object] | None, objects: list[GObject.Object]
) -> list[GObject.Object]: ...
def util_copy_string_slist(
    copy_to: list[str] | None, strings: list[str]
) -> list[str]: ...
def util_ensure_gdbus_string(str: str | None, gdbus_str: str) -> str: ...
...
def util_strcmp0(str1: str | None = None, str2: str | None = None) -> int: ...
def util_strdup_strip(string: str | None = None) -> str | None: ...
def util_strstrcase(haystack: str, needle: str) -> str | None: ...
def util_strv_equal(v1: Sequence[str], v2: Sequence[str]) -> bool: ...
def util_strv_to_slist(strv: str) -> list[str]: ...
def util_unicode_get_utf8(text: str, out: str) -> str | None: ...
def util_unref_in_thread(object: None) -> None: ...
def util_utf8_data_make_valid(data: str | None, data_bytes: int) -> str: ...
def util_utf8_decompose(text: str) -> str: ...
def util_utf8_make_valid(str: str | None = None) -> str: ...
def util_utf8_normalize(str: str | None = None) -> str | None: ...
def util_utf8_remove_accents(
    str: str | None = None,
) -> str | None: ...
def util_utf8_strcasecmp(s1: str, s2: str) -> int: ...
def util_utf8_strstrcase(
    haystack: str | None = None, needle: str | None = None
) -> str | None: ...
def util_utf8_strstrcasedecomp(haystack: str, needle: str) -> str | None: ...
...
def webdav_discover_sources(
    source: Source,
    url_use_path: str | None,
    only_supports: int,
    credentials: NamedParameters | None = None,
    cancellable: Gio.Cancellable | None = None,
    callback: Callable[..., None] | None = None,
    *user_data: Any,
) -> None: ...
...
def webdav_discover_sources_full(
    ...
    only_supports: int,
    credentials: NamedParameters | None = None,
    ref_source_func: Callable[..., Source | None] | None = None,
    cancellable: Gio.Cancellable | None = None,
    callback: Callable[..., None] | None = None,
    *user_data: Any,
) -> None: ...
...
def xmlhash_foreach_key(
    hash: XmlHash, func: Callable[..., None], *user_data: Any
) -> None: ...
def xmlhash_foreach_key_remove(
    hash: XmlHash, func: Callable[..., bool], *user_data: Any
) -> None: ...
...
class Client(GObject.Object):
    ...
    def do_get_backend_property_sync(
        self, prop_name: str, cancellable: Gio.Cancellable | None = None
    ) -> tuple[bool, str]: ...
    def do_open(
        self,
        only_if_exists: bool,
    ...
    def do_open_sync(
        self, only_if_exists: bool, cancellable: Gio.Cancellable | None = None
    ) -> bool: ...
    ...
    def do_refresh_sync(self, cancellable: Gio.Cancellable | None = None) -> bool: ...
    def do_remove(
        self,
        cancellable: Gio.Cancellable | None = None,
        callback: Callable[..., None] | None = None,
    ...
    def do_remove_sync(self, cancellable: Gio.Cancellable | None = None) -> bool: ...
    ...
    def remove_sync(self, cancellable: Gio.Cancellable | None = None) -> bool: ...
    ...
    def wait_for_connected_sync(
        self, timeout_seconds: int, cancellable: Gio.Cancellable | None = None
    ) -> bool: ...
...
class Collator(GObject.GBoxed):
    ...
    """
    def collate(
        self, str_a: str | None = None, str_b: str | None = None
    ) -> tuple[bool, int]: ...
    @staticmethod
    def error_quark() -> int: ...
    ...
    def get_index_labels(self) -> tuple[list[str], int, int, int, int]: ...
    @classmethod
...
class Extensible(GObject.GInterface):
    ...
    Signals from GObject:
      notify (GParam)
    """
    def list_extensions(self, extension_type: type[Any]) -> list[Extension]: ...
...
class GDataQuery(GObject.GBoxed):
    ...
    """
    def get_completed_max(self) -> tuple[int, bool]: ...
    def get_completed_min(self) -> tuple[int, bool]: ...
    def get_due_max(self) -> tuple[int, bool]: ...
    def get_due_min(self) -> tuple[int, bool]: ...
    def get_max_results(self) -> tuple[int, bool]: ...
    def get_show_completed(self) -> tuple[bool, bool]: ...
    def get_show_deleted(self) -> tuple[bool, bool]: ...
    def get_show_hidden(self) -> tuple[bool, bool]: ...
    def get_updated_min(self) -> tuple[int, bool]: ...
    @classmethod
...
class GDataSession(SoupSession):
    ...
    def tasklists_delete_sync(
        self, tasklist_id: str, cancellable: Gio.Cancellable | None = None
    ) -> bool: ...
    def tasklists_get_sync(
        self, tasklist_id: str, cancellable: Gio.Cancellable | None = None
    ) -> tuple[bool, Json.Object]: ...
    def tasklists_insert_sync(
        self, title: str, cancellable: Gio.Cancellable | None = None
    ) -> tuple[bool, Json.Object]: ...
    def tasklists_list_sync(
        self,
        query: GDataQuery | None = None,
...
class Module(GObject.TypeModule, GObject.TypePlugin):
    ...
    def load_all_in_directory_and_prefixes(
        dirname: str, dirprefix: str | None = None
    ) -> list[Module]: ...
    @staticmethod
...
class NamedParameters(GObject.GBoxed):
    ...
    """
    def assign(self, from_: NamedParameters | None = None) -> None: ...
    def clear(self) -> None: ...
    def count(self) -> int: ...
...
class NetworkMonitor(GObject.Object, Gio.Initable, Gio.NetworkMonitor):
    ...
    def set_gio_name(self, gio_name: str | None = None) -> None: ...
...
class OAuth2Service(GObject.GInterface):
    ...
    def delete_token_sync(
        self, source: Source, cancellable: Gio.Cancellable | None = None
    ) -> bool: ...
    ...
    def get_access_token_sync(
        self,
        source: Source,
        ref_source: Callable[..., Source | None],
        cancellable: Gio.Cancellable | None = None,
        *ref_source_user_data: Any,
    ) -> tuple[bool, str, int]: ...
    ...
    def get_client_secret(self, source: Source) -> str | None: ...
    def get_display_name(self) -> str: ...
    def get_flags(self) -> int: ...
    def get_name(self) -> str: ...
    def get_redirect_uri(self, source: Source) -> str | None: ...
    ...
    @staticmethod
    def util_extract_from_uri(in_uri: str) -> tuple[bool, str, str, str]: ...
    @staticmethod
...
class OAuth2Services(GObject.Object, Extensible):
    ...
    def find(self, source: Source) -> OAuth2Service | None: ...
    def guess(
        self,
        protocol: str | None = None,
        hostname: str | None = None,
    ) -> OAuth2Service | None: ...
    def is_oauth2_alias(self, auth_method: str | None = None) -> bool: ...
    @staticmethod
    def is_oauth2_alias_static(auth_method: str | None = None) -> bool: ...
    @staticmethod
...
class SoupSession(Soup.Session):
    ...
    def get_ssl_error_details(
        self,
    ) -> tuple[bool, str, Gio.TlsCertificateFlags]: ...
    def handle_authentication_failure(
        self, credentials: NamedParameters | None, op_error: GLib.Error
    ...
    def setup_logging(self, logging_level: str | None = None) -> None: ...
    @staticmethod
    ...
    def util_set_message_request_body_from_data(
        ...
        data: None,
        length: int,
        free_func: Callable[[None], None] | None = None,
    ) -> None: ...
    @staticmethod
    def util_status_to_string(
        status_code: int, reason_phrase: str | None = None
    ) -> str: ...
...
class Source(GObject.Object, Gio.Initable, Gio.ProxyResolver):
    ...
    def do_write_sync(self, cancellable: Gio.Cancellable | None = None) -> bool: ...
    def dup_display_name(self) -> str: ...
    def dup_parent(self) -> str | None: ...
    ...
    def lookup_password_finish(self, result: Gio.AsyncResult) -> tuple[bool, str]: ...
    ...
    def mail_signature_symlink_sync(
        self, symlink_target: str, cancellable: Gio.Cancellable | None = None
    ) -> bool: ...
    @classmethod
    def new(
        cls,
        dbus_object: Gio.DBusObject | None = None,
        main_context: GLib.MainContext | None = None,
    ) -> Source: ...
    @classmethod
    def new_with_uid(
        cls, uid: str, main_context: GLib.MainContext | None = None
    ) -> Source: ...
    @staticmethod
    ...
    def ref_dbus_object(self) -> Gio.DBusObject | None: ...
    def ref_main_context(self) -> GLib.MainContext: ...
    def refresh_add_timeout(
        self,
        context: GLib.MainContext | None,
    ...
    def set_parent(self, parent: str | None = None) -> None: ...
    def store_password(
        self,
        password: str,
        permanently: bool,
    ...
    def to_string(self) -> tuple[str, int]: ...
    ...
    def write_sync(self, cancellable: Gio.Cancellable | None = None) -> bool: ...
...
class SourceAuthentication(SourceExtension):
    ...
    def dup_credential_name(self) -> str | None: ...
    def dup_host(self) -> str | None: ...
    def dup_method(self) -> str | None: ...
    def dup_proxy_uid(self) -> str: ...
    def dup_user(self) -> str | None: ...
    def get_credential_name(self) -> str | None: ...
    ...
    def ref_connectable(self) -> Gio.SocketConnectable | None: ...
    def required(self) -> bool: ...
    def set_credential_name(self, credential_name: str | None = None) -> None: ...
    def set_host(self, host: str | None = None) -> None: ...
    ...
    def set_user(self, user: str | None = None) -> None: ...
...
class SourceBackend(SourceExtension):
    ...
    def __init__(
        self, backend_name: str | None = ..., source: Source = ...
    ) -> None: ...
    def dup_backend_name(self) -> str | None: ...
    def get_backend_name(self) -> str | None: ...
    def set_backend_name(self, backend_name: str | None = None) -> None: ...
...
class SourceCamel(SourceExtension):
    ...
    @staticmethod
    def generate_subtype(protocol: str, settings_type: type[Any]) -> type[Any]: ...
    @staticmethod
...
class SourceCollection(SourceBackend):
    ...
    def dup_calendar_url(self) -> str | None: ...
    def dup_contacts_url(self) -> str | None: ...
    def dup_identity(self) -> str | None: ...
    ...
    def get_contacts_url(self) -> str | None: ...
    ...
    def set_calendar_url(self, calendar_url: str | None = None) -> None: ...
    def set_contacts_enabled(self, contacts_enabled: bool) -> None: ...
    def set_contacts_url(self, contacts_url: str | None = None) -> None: ...
    def set_identity(self, identity: str | None = None) -> None: ...
...
class SourceCredentialsProvider(GObject.Object, Extensible):
    ...
    def do_ref_source(self, uid: str) -> Source | None: ...
    def lookup(
        self,
        source: Source,
        cancellable: Gio.Cancellable | None = None,
    ...
    def ref_credentials_source(self, source: Source) -> Source | None: ...
    def ref_registry(self) -> GObject.Object: ...
    def ref_source(self, uid: str) -> Source | None: ...
...
class SourceGoa(SourceExtension):
    ...
    def dup_account_id(self) -> str | None: ...
    def dup_address(self) -> str | None: ...
    def dup_calendar_url(self) -> str | None: ...
    def dup_contacts_url(self) -> str | None: ...
    ...
    def set_account_id(self, account_id: str | None = None) -> None: ...
    def set_address(self, address: str | None = None) -> None: ...
    def set_calendar_url(self, calendar_url: str | None = None) -> None: ...
    def set_contacts_url(self, contacts_url: str | None = None) -> None: ...
...
class SourceLocal(SourceExtension):
    ...
    def dup_custom_file(self) -> Gio.File | None: ...
    def dup_email_address(self) -> str: ...
    def get_custom_file(self) -> Gio.File | None: ...
    def get_email_address(self) -> str | None: ...
    def get_writable(self) -> bool: ...
    def set_custom_file(self, custom_file: Gio.File | None = None) -> None: ...
    def set_email_address(self, email_address: str | None = None) -> None: ...
...
class SourceMailAccount(SourceBackend):
    ...
    def dup_archive_folder(self) -> str | None: ...
    def dup_identity_uid(self) -> str | None: ...
    def get_archive_folder(self) -> str | None: ...
    def get_builtin(self) -> bool: ...
    def get_identity_uid(self) -> str | None: ...
    def get_mark_seen(self) -> ThreeState: ...
    def get_mark_seen_timeout(self) -> int: ...
    def get_needs_initial_setup(self) -> bool: ...
    def set_archive_folder(self, archive_folder: str | None = None) -> None: ...
    def set_builtin(self, builtin: int) -> None: ...
    def set_identity_uid(self, identity_uid: str | None = None) -> None: ...
...
class SourceMailComposition(SourceExtension):
    ...
    def dup_drafts_folder(self) -> str | None: ...
    def dup_language(self) -> str | None: ...
    def dup_templates_folder(self) -> str | None: ...
    def get_bcc(self) -> list[str]: ...
    def get_cc(self) -> list[str]: ...
    def get_drafts_folder(self) -> str | None: ...
    ...
    def get_templates_folder(self) -> str | None: ...
    def get_top_signature(self) -> ThreeState: ...
    def set_bcc(self, bcc: Sequence[str]) -> None: ...
    def set_cc(self, cc: Sequence[str]) -> None: ...
    def set_drafts_folder(self, drafts_folder: str | None = None) -> None: ...
    ...
    def set_templates_folder(self, templates_folder: str | None = None) -> None: ...
...
class SourceMailIdentity(SourceExtension):
    ...
    def dup_address(self) -> str | None: ...
    def dup_aliases(self) -> str | None: ...
    def dup_name(self) -> str | None: ...
    def dup_organization(self) -> str | None: ...
    def dup_reply_to(self) -> str | None: ...
    def dup_signature_uid(self) -> str | None: ...
    def get_address(self) -> str | None: ...
    def get_aliases(self) -> str | None: ...
    def get_aliases_as_hash_table(self) -> dict[str, str] | None: ...
    def get_name(self) -> str | None: ...
    def get_organization(self) -> str | None: ...
    def get_reply_to(self) -> str | None: ...
    def get_signature_uid(self) -> str | None: ...
    def set_address(self, address: str | None = None) -> None: ...
    def set_aliases(self, aliases: str | None = None) -> None: ...
    def set_name(self, name: str | None = None) -> None: ...
    def set_organization(self, organization: str | None = None) -> None: ...
    def set_reply_to(self, reply_to: str | None = None) -> None: ...
    def set_signature_uid(self, signature_uid: str | None = None) -> None: ...
...
class SourceMailSignature(SourceExtension):
    ...
    def dup_mime_type(self) -> str | None: ...
    def get_file(self) -> Gio.File: ...
    def get_mime_type(self) -> str | None: ...
    def set_mime_type(self, mime_type: str | None = None) -> None: ...
...
class SourceMailSubmission(SourceExtension):
    ...
    def dup_sent_folder(self) -> str | None: ...
    def dup_transport_uid(self) -> str | None: ...
    def get_replies_to_origin_folder(self) -> bool: ...
    def get_sent_folder(self) -> str | None: ...
    def get_transport_uid(self) -> str | None: ...
    def get_use_sent_folder(self) -> bool: ...
    def set_replies_to_origin_folder(self, replies_to_origin_folder: bool) -> None: ...
    def set_sent_folder(self, sent_folder: str | None = None) -> None: ...
    def set_transport_uid(self, transport_uid: str | None = None) -> None: ...
...
class SourceRegistry(GObject.Object, Gio.AsyncInitable, Gio.Initable):
    ...
    """
    class Props(GObject.Object.Props):
        default_address_book: Source | None
        default_calendar: Source | None
        default_mail_account: Source | None
        default_mail_identity: Source | None
        default_memo_list: Source | None
        default_task_list: Source | None
    ...
    def debug_dump(self, extension_name: str | None = None) -> None: ...
    @staticmethod
    ...
    def dup_unique_display_name(
        self, source: Source, extension_name: str | None = None
    ) -> str: ...
    def find_extension(self, source: Source, extension_name: str) -> Source | None: ...
    @staticmethod
    def free_display_tree(display_tree: GLib.Node) -> None: ...
    def get_oauth2_services(self) -> OAuth2Services: ...
    def list_enabled(self, extension_name: str | None = None) -> list[Source]: ...
    def list_sources(self, extension_name: str | None = None) -> list[Source]: ...
    @staticmethod
    def new(
        cancellable: Gio.Cancellable | None = None,
        callback: Callable[..., None] | None = None,
    ...
    @classmethod
    def new_sync(cls, cancellable: Gio.Cancellable | None = None) -> SourceRegistry: ...
    ...
    def ref_default_for_extension_name(self, extension_name: str) -> Source | None: ...
    def ref_default_mail_account(self) -> Source: ...
    def ref_default_mail_identity(self) -> Source | None: ...
    ...
    def refresh_backend_sync(
        self, source_uid: str, cancellable: Gio.Cancellable | None = None
    ) -> bool: ...
    def set_default_address_book(
        self, default_source: Source | None = None
    ) -> None: ...
    def set_default_calendar(self, default_source: Source | None = None) -> None: ...
    def set_default_for_extension_name(
        self, extension_name: str, default_source: Source | None = None
    ) -> None: ...
    ...
    def set_default_memo_list(self, default_source: Source | None = None) -> None: ...
    def set_default_task_list(self, default_source: Source | None = None) -> None: ...
...
class SourceRegistryWatcher(GObject.Object):
    ...
    def get_extension_name(self) -> str | None: ...
    def get_registry(self) -> SourceRegistry: ...
    @classmethod
    def new(
        cls, registry: SourceRegistry, extension_name: str | None = None
...
class SourceSMIME(SourceExtension):
    ...
    def dup_encryption_certificate(self) -> str | None: ...
    def dup_signing_algorithm(self) -> str | None: ...
    def dup_signing_certificate(self) -> str | None: ...
    def get_encrypt_by_default(self) -> bool: ...
    def get_encrypt_to_self(self) -> bool: ...
    def get_encryption_certificate(self) -> str | None: ...
    def get_sign_by_default(self) -> bool: ...
    def get_signing_algorithm(self) -> str | None: ...
    def get_signing_certificate(self) -> str | None: ...
    def set_encrypt_by_default(self, encrypt_by_default: bool) -> None: ...
    def set_encrypt_to_self(self, encrypt_to_self: bool) -> None: ...
    def set_encryption_certificate(
        self, encryption_certificate: str | None = None
    ) -> None: ...
    def set_sign_by_default(self, sign_by_default: bool) -> None: ...
    def set_signing_algorithm(self, signing_algorithm: str | None = None) -> None: ...
    def set_signing_certificate(
        self, signing_certificate: str | None = None
    ) -> None: ...
...
class SourceWebDAVNotes(SourceExtension):
    ...
    def dup_default_ext(self) -> str | None: ...
    def get_default_ext(self) -> str | None: ...
    def set_default_ext(self, default_ext: str | None = None) -> None: ...
...
class SourceWebdav(SourceExtension):
    ...
    def dup_color(self) -> str | None: ...
    def dup_display_name(self) -> str | None: ...
    def dup_email_address(self) -> str | None: ...
    def dup_resource_path(self) -> str | None: ...
    def dup_resource_query(self) -> str | None: ...
    def dup_ssl_trust(self) -> str | None: ...
    ...
    def get_resource_query(self) -> str | None: ...
    def get_ssl_trust(self) -> str | None: ...
    ...
    def set_email_address(self, email_address: str | None = None) -> None: ...
    def set_order(self, order: int) -> None: ...
    def set_resource_path(self, resource_path: str | None = None) -> None: ...
    def set_resource_query(self, resource_query: str | None = None) -> None: ...
    def set_ssl_trust(self, ssl_trust: str | None = None) -> None: ...
...
class WebDAVPropertyChange(GObject.GBoxed):
    ...
    @classmethod
    def new_set(
        cls, ns_uri: str, name: str, value: str | None = None
    ) -> WebDAVPropertyChange: ...
...
class WebDAVSession(SoupSession):
    ...
    def get_acl_restrictions_sync(
        ...
        uri: str | None = None,
        cancellable: Gio.Cancellable | None = None,
    ) -> tuple[bool, int, WebDAVACEPrincipalKind, list[str]]: ...
    def get_acl_sync(
        self,
        uri: str | None = None,
        cancellable: Gio.Cancellable | None = None,
    ) -> tuple[bool, list[WebDAVAccessControlEntry]]: ...
    def get_current_user_privilege_set_full_sync(
        self,
        uri: str | None = None,
        cancellable: Gio.Cancellable | None = None,
    ) -> tuple[bool, list[WebDAVPrivilege], dict[None, None], dict[None, None]]: ...
    ...
    def list_sync(
        ...
        flags: int,
        cancellable: Gio.Cancellable | None = None,
    ) -> tuple[bool, list[WebDAVResource]]: ...
    ...
    def report_sync(
        ...
        xml: XmlDocument,
        func: Callable[..., bool] | None = None,
        out_content_type: str | None = None,
        out_content: Sequence[int] | None = None,
        cancellable: Gio.Cancellable | None = None,
        *func_user_data: Any,
    ) -> bool: ...
    def set_acl_sync(
    ...
    @staticmethod
    def util_free_privileges(privileges: GLib.Node | None = None) -> None: ...
    @staticmethod
    def util_item_href_equal(href1: str, href2: str) -> bool: ...
    @staticmethod
    def util_maybe_dequote() -> tuple[str, str]: ...
...
class XmlDocument(GObject.Object):
    ...
    def add_attribute_double(
        self, ns_href: str | None, name: str, value: float
    ) -> None: ...
    def add_attribute_int(self, ns_href: str | None, name: str, value: int) -> None: ...
    def add_attribute_time(
        self, ns_href: str | None, name: str, value: int
    ) -> None: ...
    def add_attribute_time_ical(
        self, ns_href: str | None, name: str, value: int
    ) -> None: ...
    def add_empty_element(self, ns_href: str | None, name: str) -> None: ...
    def end_element(self) -> None: ...
    def get_content(self) -> tuple[str, int]: ...
    def get_xmldoc(self) -> libxml2.Doc: ...
    @classmethod
    def new(cls, ns_href: str | None, root_element: str) -> XmlDocument: ...
    def start_element(self, ns_href: str | None, name: str) -> None: ...
    def start_text_element(self, ns_href: str | None, name: str) -> None: ...
