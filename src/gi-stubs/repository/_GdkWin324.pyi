...
class Win32Display(_Gdk4.Display):
    ...
    @staticmethod
    def get_wgl_version(display: _Gdk4.Display) -> tuple[bool, int, int]: ...
    def remove_filter(
        self,
        function: Callable[..., Win32MessageFilterReturn],
        *data: Any,
...
class Win32DisplayManager(_Gdk4.DisplayManager): ...
class Win32DisplayManagerClass(GObject.GPointer): ...
class Win32Drag(_Gdk4.Drag): ...
class Win32DragClass(GObject.GPointer): ...
class Win32GLContext(_Gdk4.GLContext): ...
...
class Win32Monitor(_Gdk4.Monitor):
    """
    :Constructors:
...
class Win32Surface(_Gdk4.Surface):
    """
    :Constructors:
    ...
    @staticmethod
    def get_impl_hwnd(surface: _Gdk4.Surface) -> int: ...
    @staticmethod
    def is_win32(surface: _Gdk4.Surface) -> bool: ...
