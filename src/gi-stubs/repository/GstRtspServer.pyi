...
class RTSPMedia(GObject.Object):
    ...
    def do_prepare(self, thread: RTSPThread | None = None) -> bool: ...
...
class RTSPMediaClass(GObject.GPointer):
    ...
    prepare: Callable[[RTSPMedia, RTSPThread | None], bool]
...
class RTSPMediaFactoryClass(GObject.GPointer):
    ...
    create_element: Callable[[RTSPMediaFactory, GstRtsp.RTSPUrl], Gst.Element | None]
    construct: Callable[[RTSPMediaFactory, GstRtsp.RTSPUrl], RTSPMedia | None]
...
class RTSPMountPointsClass(GObject.GPointer):
    ...
    parent_class: GObject.ObjectClass
    make_path: Callable[[RTSPMountPoints, GstRtsp.RTSPUrl], str | None]
...
class RTSPOnvifMediaFactoryClass(GObject.GPointer):
    ...
    create_backchannel_stream: Callable[
...
class RTSPThreadPoolClass(GObject.GPointer):
    ...
    get_thread: Callable[
        [RTSPThreadPool, RTSPThreadType, RTSPContext], RTSPThread | None
    ]
