...
RTSPClientSendFunc: TypeAlias = Callable[
    [RTSPClient, GstRtsp.RTSPMessage, bool, Unpack[_DataTs]], bool
]
RTSPClientSendMessagesFunc: TypeAlias = Callable[
    [RTSPClient, GstRtsp.RTSPMessage, int, bool, Unpack[_DataTs]], bool
]
RTSPClientSessionFilterFunc: TypeAlias = Callable[
    [RTSPClient, RTSPSession, Unpack[_DataTs]], RTSPFilterResult
]
RTSPKeepAliveFunc: TypeAlias = Callable[[Unpack[_DataTs]], None]
RTSPMessageSentFunc: TypeAlias = Callable[[Unpack[_DataTs]], None]
RTSPMessageSentFuncFull: TypeAlias = Callable[
    [RTSPStreamTransport, Unpack[_DataTs]], None
]
RTSPSendFunc: TypeAlias = Callable[[Gst.Buffer, int, Unpack[_DataTs]], bool]
RTSPSendListFunc: TypeAlias = Callable[[Gst.BufferList, int, Unpack[_DataTs]], bool]
RTSPServerClientFilterFunc: TypeAlias = Callable[
    [RTSPServer, RTSPClient, Unpack[_DataTs]], RTSPFilterResult
]
RTSPSessionFilterFunc: TypeAlias = Callable[
    [RTSPSession, RTSPSessionMedia, Unpack[_DataTs]], RTSPFilterResult
]
RTSPSessionPoolFilterFunc: TypeAlias = Callable[
    [RTSPSessionPool, RTSPSession, Unpack[_DataTs]], RTSPFilterResult
]
RTSPSessionPoolFunc: TypeAlias = Callable[[RTSPSessionPool, Unpack[_DataTs]], bool]
RTSPStreamTransportFilterFunc: TypeAlias = Callable[
    [RTSPStream, RTSPStreamTransport, Unpack[_DataTs]], RTSPFilterResult
]
...
class RTSPAddressPool(GObject.Object):
    ...
    @property
    def priv(self) -> RTSPAddressPoolPrivate: ...
    def acquire_address(
...
class RTSPAuth(GObject.Object):
    ...
    def set_default_token(self, token: RTSPToken | None = ...) -> None: ...
    ...
    def set_tls_certificate(self, cert: Gio.TlsCertificate | None = ...) -> None: ...
    def set_tls_database(self, database: Gio.TlsDatabase | None = ...) -> None: ...
...
class RTSPAuthClass(_gi.Struct):
    ...
    def parent_class(self) -> GObject.ObjectClass: ...
    @property
    def authenticate(self) -> Callable[[RTSPAuth, RTSPContext], bool]: ...
    @property
    def check(self) -> Callable[[RTSPAuth, RTSPContext, str], bool]: ...
    @property
    def generate_authenticate_header(
        self,
    ) -> Callable[[RTSPAuth, RTSPContext], None]: ...
    @property
...
class RTSPClient(GObject.Object):
    ...
    def parent(self) -> GObject.Object: ...
    @property
    def priv(self) -> RTSPClientPrivate: ...
    def __init__(
        self,
        *,
        drop_backlog: bool = ...,
    ...
    def attach(self, context: GLib.MainContext | None = ...) -> int: ...
    def close(self) -> None: ...
    ...
    def session_filter(
        self,
        func: RTSPClientSessionFilterFunc[Unpack[_DataTs]] | None = ...,
        *user_data: Unpack[_DataTs],
    ) -> list[RTSPSession]: ...
    def set_auth(self, auth: RTSPAuth | None = ...) -> None: ...
    def set_connection(self, conn: GstRtsp.RTSPConnection) -> bool: ...
    def set_content_length_limit(self, limit: int) -> None: ...
    def set_mount_points(self, mounts: RTSPMountPoints | None = ...) -> None: ...
    def set_send_func(
        self, func: RTSPClientSendFunc[Unpack[_DataTs]], *user_data: Unpack[_DataTs]
    ) -> None: ...
    def set_send_messages_func(
        self,
        func: RTSPClientSendMessagesFunc[Unpack[_DataTs]],
        *user_data: Unpack[_DataTs],
    ) -> None: ...
    def set_session_pool(self, pool: RTSPSessionPool | None = ...) -> None: ...
    def set_thread_pool(self, pool: RTSPThreadPool | None = ...) -> None: ...
...
class RTSPClientClass(_gi.Struct):
    ...
    def parent_class(self) -> GObject.ObjectClass: ...
    @property
    def create_sdp(self) -> Callable[[RTSPClient, RTSPMedia], GstSdp.SDPMessage]: ...
    @property
    def configure_client_media(
        self,
    ) -> Callable[[RTSPClient, RTSPMedia, RTSPStream, RTSPContext], bool]: ...
    @property
    def configure_client_transport(
        self,
    ) -> Callable[[RTSPClient, RTSPContext, GstRtsp.RTSPTransport], bool]: ...
    @property
    def params_set(self) -> Callable[[RTSPClient, RTSPContext], GstRtsp.RTSPResult]: ...
    @property
    def params_get(self) -> Callable[[RTSPClient, RTSPContext], GstRtsp.RTSPResult]: ...
    @property
    def make_path_from_uri(self) -> Callable[[RTSPClient, GstRtsp.RTSPUrl], str]: ...
    @property
    def adjust_play_mode(
        self,
    ) -> Callable[
        [
            RTSPClient,
    ...
    @property
    def adjust_play_response(
        self,
    ) -> Callable[[RTSPClient, RTSPContext], GstRtsp.RTSPStatusCode]: ...
    @property
    def closed(self) -> Callable[[RTSPClient], None]: ...
    @property
    def new_session(self) -> Callable[[RTSPClient, RTSPSession], None]: ...
    @property
    def options_request(self) -> Callable[[RTSPClient, RTSPContext], None]: ...
    @property
    def describe_request(self) -> Callable[[RTSPClient, RTSPContext], None]: ...
    @property
    def setup_request(self) -> Callable[[RTSPClient, RTSPContext], None]: ...
    @property
    def play_request(self) -> Callable[[RTSPClient, RTSPContext], None]: ...
    @property
    def pause_request(self) -> Callable[[RTSPClient, RTSPContext], None]: ...
    @property
    def teardown_request(self) -> Callable[[RTSPClient, RTSPContext], None]: ...
    @property
    def set_parameter_request(self) -> Callable[[RTSPClient, RTSPContext], None]: ...
    @property
    def get_parameter_request(self) -> Callable[[RTSPClient, RTSPContext], None]: ...
    @property
    def handle_response(self) -> Callable[[RTSPClient, RTSPContext], None]: ...
    @property
    def tunnel_http_response(
        self,
    ) -> Callable[[RTSPClient, GstRtsp.RTSPMessage, GstRtsp.RTSPMessage], None]: ...
    @property
    def send_message(
        self,
    ) -> Callable[[RTSPClient, RTSPContext, GstRtsp.RTSPMessage], None]: ...
    @property
    def handle_sdp(
        self,
    ) -> Callable[[RTSPClient, RTSPContext, RTSPMedia, GstSdp.SDPMessage], bool]: ...
    @property
    def announce_request(self) -> Callable[[RTSPClient, RTSPContext], None]: ...
    @property
    def record_request(self) -> Callable[[RTSPClient, RTSPContext], None]: ...
    @property
    def check_requirements(self) -> Callable[[RTSPClient, RTSPContext, str], str]: ...
    @property
    def pre_options_request(
        self,
    ) -> Callable[[RTSPClient, RTSPContext], GstRtsp.RTSPStatusCode]: ...
    @property
    def pre_describe_request(
        self,
    ) -> Callable[[RTSPClient, RTSPContext], GstRtsp.RTSPStatusCode]: ...
    @property
    def pre_setup_request(
        self,
    ) -> Callable[[RTSPClient, RTSPContext], GstRtsp.RTSPStatusCode]: ...
    @property
    def pre_play_request(
        self,
    ) -> Callable[[RTSPClient, RTSPContext], GstRtsp.RTSPStatusCode]: ...
    @property
    def pre_pause_request(
        self,
    ) -> Callable[[RTSPClient, RTSPContext], GstRtsp.RTSPStatusCode]: ...
    @property
    def pre_teardown_request(
        self,
    ) -> Callable[[RTSPClient, RTSPContext], GstRtsp.RTSPStatusCode]: ...
    @property
    def pre_set_parameter_request(
        self,
    ) -> Callable[[RTSPClient, RTSPContext], GstRtsp.RTSPStatusCode]: ...
    @property
    def pre_get_parameter_request(
        self,
    ) -> Callable[[RTSPClient, RTSPContext], GstRtsp.RTSPStatusCode]: ...
    @property
    def pre_announce_request(
        self,
    ) -> Callable[[RTSPClient, RTSPContext], GstRtsp.RTSPStatusCode]: ...
    @property
    def pre_record_request(
        self,
    ) -> Callable[[RTSPClient, RTSPContext], GstRtsp.RTSPStatusCode]: ...
    @property
    def adjust_error_code(
        self,
    ) -> Callable[
...
class RTSPMedia(GObject.Object):
    ...
    def parent(self) -> GObject.Object: ...
    @property
    def priv(self) -> RTSPMediaPrivate: ...
    def __init__(
        self,
        *,
        bind_mcast_address: bool = ...,
    ...
    def do_prepare(self, thread: RTSPThread | None) -> bool: ...
    ...
    def get_time_provider(
        self, address: str | None, port: int
    ) -> GstNet.NetTimeProvider | None: ...
    ...
    def prepare(self, thread: RTSPThread | None = ...) -> bool: ...
    ...
    def set_address_pool(self, pool: RTSPAddressPool | None = ...) -> None: ...
    def set_bind_mcast_address(self, bind_mcast_addr: bool) -> None: ...
    def set_buffer_size(self, size: int) -> None: ...
    def set_clock(self, clock: Gst.Clock | None = ...) -> None: ...
    ...
    def set_multicast_iface(self, multicast_iface: str | None = ...) -> None: ...
    def set_permissions(self, permissions: RTSPPermissions | None = ...) -> None: ...
...
class RTSPMediaClass(_gi.Struct):
    ...
    def parent_class(self) -> GObject.ObjectClass: ...
    @property
    def handle_message(self) -> Callable[[RTSPMedia, Gst.Message], bool]: ...
    @property
    def prepare(self) -> Callable[[RTSPMedia, RTSPThread | None], bool]: ...
    @property
    def unprepare(self) -> Callable[[RTSPMedia], bool]: ...
    @property
    def suspend(self) -> Callable[[RTSPMedia], bool]: ...
    @property
    def unsuspend(self) -> Callable[[RTSPMedia], bool]: ...
    @property
    def convert_range(
        self,
    ) -> Callable[[RTSPMedia, GstRtsp.RTSPTimeRange, GstRtsp.RTSPRangeUnit], bool]: ...
    @property
    def query_position(self) -> Callable[[RTSPMedia, int], bool]: ...
    @property
    def query_stop(self) -> Callable[[RTSPMedia, int], bool]: ...
    @property
    def create_rtpbin(self) -> int | Any | None: ...
    @property
    def setup_rtpbin(self) -> Callable[[RTSPMedia, Gst.Element], bool]: ...
    @property
    def setup_sdp(self) -> Callable[[RTSPMedia, GstSdp.SDPMessage, SDPInfo], bool]: ...
    @property
    def new_stream(self) -> Callable[[RTSPMedia, RTSPStream], None]: ...
    @property
    def removed_stream(self) -> Callable[[RTSPMedia, RTSPStream], None]: ...
    @property
    def prepared(self) -> Callable[[RTSPMedia], None]: ...
    @property
    def unprepared(self) -> Callable[[RTSPMedia], None]: ...
    @property
    def target_state(self) -> Callable[[RTSPMedia, Gst.State], None]: ...
    @property
    def new_state(self) -> Callable[[RTSPMedia, Gst.State], None]: ...
    @property
    def handle_sdp(self) -> Callable[[RTSPMedia, GstSdp.SDPMessage], bool]: ...
...
class RTSPMediaFactory(GObject.Object):
    ...
    def parent(self) -> GObject.Object: ...
    @property
    def priv(self) -> RTSPMediaFactoryPrivate: ...
    def __init__(
        self,
        *,
        bind_mcast_address: bool = ...,
    ...
    def do_construct(self, url: GstRtsp.RTSPUrl) -> RTSPMedia | None: ...
    def do_create_element(self, url: GstRtsp.RTSPUrl) -> Gst.Element | None: ...
    ...
    def get_max_mcast_ttl(self) -> int: ...
    def get_media_gtype(self) -> type[Any]: ...
    def get_multicast_iface(self) -> str | None: ...
    def get_permissions(self) -> RTSPPermissions | None: ...
    def get_profiles(self) -> GstRtsp.RTSPProfile: ...
    def get_protocols(self) -> GstRtsp.RTSPLowerTrans: ...
    ...
    def set_max_mcast_ttl(self, ttl: int) -> bool: ...
    def set_media_gtype(self, media_gtype: type[Any]) -> None: ...
    def set_multicast_iface(self, multicast_iface: str | None = ...) -> None: ...
    def set_permissions(self, permissions: RTSPPermissions | None = ...) -> None: ...
    def set_profiles(self, profiles: GstRtsp.RTSPProfile) -> None: ...
    def set_protocols(self, protocols: GstRtsp.RTSPLowerTrans) -> None: ...
...
class RTSPMediaFactoryClass(_gi.Struct):
    ...
    def parent_class(self) -> GObject.ObjectClass: ...
    @property
    def gen_key(self) -> Callable[[RTSPMediaFactory, GstRtsp.RTSPUrl], str]: ...
    @property
    def create_element(
        self,
    ) -> Callable[[RTSPMediaFactory, GstRtsp.RTSPUrl], Gst.Element | None]: ...
    @property
    def construct(
        self,
    ) -> Callable[[RTSPMediaFactory, GstRtsp.RTSPUrl], RTSPMedia | None]: ...
    @property
    def create_pipeline(self) -> int | Any | None: ...
    @property
    def configure(self) -> Callable[[RTSPMediaFactory, RTSPMedia], None]: ...
    @property
    def media_constructed(self) -> Callable[[RTSPMediaFactory, RTSPMedia], None]: ...
    @property
...
class RTSPMediaFactoryURI(RTSPMediaFactory):
    ...
    @property
    def priv(self) -> RTSPMediaFactoryURIPrivate: ...
    def __init__(
        self,
        *,
        uri: str = ...,
...
class RTSPMountPoints(GObject.Object):
    ...
    def parent(self) -> GObject.Object: ...
    @property
    def priv(self) -> RTSPMountPointsPrivate: ...
    def add_factory(self, path: str, factory: RTSPMediaFactory) -> None: ...
    def do_make_path(self, url: GstRtsp.RTSPUrl) -> str | None: ...
...
class RTSPOnvifClientClass(_gi.Struct):
    ...
    """
    @property
    def parent(self) -> RTSPClientClass: ...
...
class RTSPOnvifMedia(RTSPMedia):
    ...
    @property
    def priv(self) -> RTSPOnvifMediaPrivate: ...
    def __init__(
        self,
        *,
        bind_mcast_address: bool = ...,
...
class RTSPOnvifMediaClass(_gi.Struct):
    ...
    """
    @property
    def parent(self) -> RTSPMediaClass: ...
...
class RTSPOnvifMediaFactory(RTSPMediaFactory):
    ...
    def parent(self) -> RTSPMediaFactory: ...
    @property
    def priv(self) -> RTSPOnvifMediaFactoryPrivate: ...
    def __init__(
        self,
        *,
        bind_mcast_address: bool = ...,
    ...
    def set_backchannel_bandwidth(self, bandwidth: int) -> None: ...
    def set_backchannel_launch(self, launch: str | None = ...) -> None: ...
...
class RTSPOnvifMediaFactoryClass(_gi.Struct):
    ...
    """
    @property
    def parent(self) -> RTSPMediaFactoryClass: ...
    @property
    def has_backchannel_support(self) -> Callable[[RTSPOnvifMediaFactory], bool]: ...
    @property
    def create_backchannel_stream(
        self,
...
class RTSPOnvifServerClass(_gi.Struct):
    ...
    """
    @property
    def parent(self) -> RTSPServerClass: ...
...
class RTSPServer(GObject.Object):
    ...
    def parent(self) -> GObject.Object: ...
    @property
    def priv(self) -> RTSPServerPrivate: ...
    def __init__(
        self,
        *,
        address: str = ...,
    ...
    def client_filter(
        self,
        func: RTSPServerClientFilterFunc[Unpack[_DataTs]] | None = ...,
        *user_data: Unpack[_DataTs],
    ) -> list[RTSPClient]: ...
    def create_socket(
        self, cancellable: Gio.Cancellable | None = ...
    ) -> Gio.Socket: ...
    def create_source(
        self, cancellable: Gio.Cancellable | None = ...
    ) -> GLib.Source: ...
    ...
    def transfer_connection(
        self, socket: Gio.Socket, ip: str, port: int, initial_buffer: str | None = ...
    ) -> bool: ...
...
class RTSPServerClass(_gi.Struct):
    ...
    def parent_class(self) -> GObject.ObjectClass: ...
    @property
    def create_client(self) -> int | Any | None: ...
    @property
...
class RTSPSession(GObject.Object):
    ...
    def parent(self) -> GObject.Object: ...
    @property
    def priv(self) -> RTSPSessionPrivate: ...
    def __init__(
        self,
        *,
        extra_timeout: int = ...,
    ...
    def filter(
        self,
        func: RTSPSessionFilterFunc[Unpack[_DataTs]] | None = ...,
        *user_data: Unpack[_DataTs],
...
class RTSPSessionMedia(GObject.Object):
    ...
    def parent(self) -> GObject.Object: ...
    @property
    def priv(self) -> RTSPSessionMediaPrivate: ...
...
class RTSPSessionPool(GObject.Object):
    ...
    def parent(self) -> GObject.Object: ...
    @property
    def priv(self) -> RTSPSessionPoolPrivate: ...
    ...
    def filter(
        self,
        func: RTSPSessionPoolFilterFunc[Unpack[_DataTs]] | None = ...,
        *user_data: Unpack[_DataTs],
    ) -> list[RTSPSession]: ...
...
class RTSPSessionPoolClass(_gi.Struct):
    ...
    def parent_class(self) -> GObject.ObjectClass: ...
    @property
    def create_session_id(self) -> Callable[[RTSPSessionPool], str]: ...
    @property
    def create_session(self) -> int | Any | None: ...
    @property
...
class RTSPStream(GObject.Object):
    ...
    def parent(self) -> GObject.Object: ...
    @property
    def priv(self) -> RTSPStreamPrivate: ...
    def __init__(
        self,
        *,
        control: str | None = ...,
    ...
    def has_control(self, control: str | None = ...) -> bool: ...
    def is_bind_mcast_address(self) -> bool: ...
    ...
    def set_control(self, control: str | None = ...) -> None: ...
    def set_dscp_qos(self, dscp_qos: int) -> None: ...
    def set_max_mcast_ttl(self, ttl: int) -> bool: ...
    ...
    def transport_filter(
        self,
        func: RTSPStreamTransportFilterFunc[Unpack[_DataTs]] | None = ...,
        *user_data: Unpack[_DataTs],
    ) -> list[RTSPStreamTransport]: ...
    def unblock_linked(self) -> bool: ...
    def unblock_rtcp(self) -> None: ...
    def update_crypto(self, ssrc: int, crypto: Gst.Caps | None = ...) -> bool: ...
...
class RTSPStreamTransport(GObject.Object):
    ...
    def parent(self) -> GObject.Object: ...
    @property
    def priv(self) -> RTSPStreamTransportPrivate: ...
    ...
    def set_callbacks(
        self,
        send_rtp: RTSPSendFunc[Unpack[_DataTs]],
        send_rtcp: RTSPSendFunc[Unpack[_DataTs]],
        *user_data: Unpack[_DataTs],
    ) -> None: ...
    def set_keepalive(
        self,
        keep_alive: RTSPKeepAliveFunc[Unpack[_DataTs]],
        *user_data: Unpack[_DataTs],
    ) -> None: ...
    def set_list_callbacks(
        self,
        send_rtp_list: RTSPSendListFunc[Unpack[_DataTs]],
        send_rtcp_list: RTSPSendListFunc[Unpack[_DataTs]],
        *user_data: Unpack[_DataTs],
    ) -> None: ...
    def set_message_sent(
        self,
        message_sent: RTSPMessageSentFunc[Unpack[_DataTs]],
        *user_data: Unpack[_DataTs],
    ) -> None: ...
    def set_message_sent_full(
        self,
        message_sent: RTSPMessageSentFuncFull[Unpack[_DataTs]],
        *user_data: Unpack[_DataTs],
    ) -> None: ...
    def set_timed_out(self, timedout: bool) -> None: ...
    def set_transport(self, tr: GstRtsp.RTSPTransport) -> None: ...
    def set_url(self, url: GstRtsp.RTSPUrl | None = ...) -> None: ...
...
class RTSPThreadPool(GObject.Object):
    ...
    def parent(self) -> GObject.Object: ...
    @property
    def priv(self) -> RTSPThreadPoolPrivate: ...
...
class RTSPThreadPoolClass(_gi.Struct):
    ...
    def get_thread(
        self,
    ) -> Callable[[RTSPThreadPool, RTSPThreadType, RTSPContext], RTSPThread | None]: ...
    @property
    def configure_thread(
        self,
    ) -> Callable[[RTSPThreadPool, RTSPThread, RTSPContext], None]: ...
    @property
    def thread_enter(self) -> Callable[[RTSPThreadPool, RTSPThread], None]: ...
    @property
