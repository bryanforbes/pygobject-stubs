...
class WebRTCICEClass(GObject.GPointer):
    ...
    add_stream: Callable[[WebRTCICE, int], WebRTCICEStream | None]
    find_transport: Callable[
        [WebRTCICE, WebRTCICEStream, WebRTCICEComponent],
        WebRTCICETransport | None,
    ]
    gather_candidates: Callable[[WebRTCICE, WebRTCICEStream], bool]
    add_candidate: Callable[[WebRTCICE, WebRTCICEStream, str, Gst.Promise | None], None]
    set_local_credentials: Callable[[WebRTCICE, WebRTCICEStream, str, str], bool]
    set_remote_credentials: Callable[[WebRTCICE, WebRTCICEStream, str, str], bool]
    add_turn_server: Callable[[WebRTCICE, str], bool]
    set_is_controller: Callable[[WebRTCICE, bool], None]
    get_is_controller: Callable[[WebRTCICE], bool]
    set_force_relay: Callable[[WebRTCICE, bool], None]
    set_stun_server: Callable[[WebRTCICE, str | None], None]
    get_stun_server: Callable[[WebRTCICE], str | None]
    set_turn_server: Callable[[WebRTCICE, str | None], None]
    get_turn_server: Callable[[WebRTCICE], str | None]
    set_http_proxy: Callable[[WebRTCICE, str], None]
    get_http_proxy: Callable[[WebRTCICE], str]
    set_tos: Callable[[WebRTCICE, WebRTCICEStream, int], None]
    set_on_ice_candidate: Callable[..., None]
    get_local_candidates: Callable[
        [WebRTCICE, WebRTCICEStream], WebRTCICECandidateStats
    ]
    get_remote_candidates: Callable[
        [WebRTCICE, WebRTCICEStream], WebRTCICECandidateStats
    ]
    get_selected_pair: Callable[
...
class WebRTCICEStreamClass(GObject.GPointer):
    ...
    parent_class: Gst.ObjectClass
    find_transport: Callable[
        [WebRTCICEStream, WebRTCICEComponent], WebRTCICETransport | None
    ]
    gather_candidates: Callable[[WebRTCICEStream], bool]
...
class WebRTCICETransportClass(GObject.GPointer):
    ...
    parent_class: Gst.ObjectClass
    gather_candidates: Callable[[WebRTCICETransport], bool]
