...
WebRTCICEOnCandidateFunc: TypeAlias = Callable[
    [WebRTCICE, int, str, Unpack[_DataTs]], None
]
...
class WebRTCDTLSTransportClass(_gi.Struct): ...
...
class WebRTCDataChannel(GObject.Object):
    ...
    def close(self) -> None: ...
    def send_data(self, data: GLib.Bytes | None = ...) -> None: ...
    def send_data_full(self, data: GLib.Bytes | None = ...) -> bool: ...
    def send_string(self, str: str | None = ...) -> None: ...
    def send_string_full(self, str: str | None = ...) -> bool: ...

class WebRTCDataChannelClass(_gi.Struct): ...
...
class WebRTCICE(Gst.Object):
    ...
    def close(self, promise: Gst.Promise | None = ...) -> None: ...
    ...
    def do_set_on_ice_candidate(
        self,
        func: WebRTCICEOnCandidateFunc[Unpack[_DataTs]],
    ...
    def set_stun_server(self, uri: str | None = ...) -> None: ...
    def set_tos(self, stream: WebRTCICEStream, tos: int) -> None: ...
    def set_turn_server(self, uri: str | None = ...) -> None: ...
...
class WebRTCICEClass(_gi.Struct):
    """
    :Constructors:
    ...
    def set_on_ice_candidate(
        ...
        [
            WebRTCICE,
            WebRTCICEOnCandidateFunc[Unpack[_DataTs]],
            GLib.DestroyNotify,
            Unpack[_DataTs],
        ],
        None,
...
class WebRTCICEStreamClass(_gi.Struct):
    """
    :Constructors:
...
class WebRTCICETransportClass(_gi.Struct):
    """
    :Constructors:
...
class WebRTCRTPReceiverClass(_gi.Struct): ...
...
class WebRTCRTPTransceiverClass(_gi.Struct): ...
...
class WebRTCSCTPTransportClass(_gi.Struct): ...
