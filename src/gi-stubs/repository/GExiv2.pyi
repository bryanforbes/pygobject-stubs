...
class Metadata(GObject.Object):
    ...
    def free(self) -> None: ...
    def from_app1_segment(self, data: Sequence[int]) -> bool: ...
    ...
    def get_exif_data(self, byte_order: ByteOrder) -> GLib.Bytes | None: ...
    # override
    def get_exif_tag_rational(self, key) -> Fraction | None: ...
    def get_exif_tags(self) -> list[str]: ...
    def get_exif_thumbnail(self) -> tuple[bool, bytes]: ...
    # override
    def get_exposure_time(self) -> Fraction | None: ...
    def get_fnumber(self) -> float: ...
    def get_focal_length(self) -> float: ...
    def get_gps_altitude(self) -> tuple[bool, float]: ...
    def get_gps_info(self) -> tuple[bool, float, float, float]: ...
    def get_gps_latitude(self) -> tuple[bool, float]: ...
    def get_gps_longitude(self) -> tuple[bool, float]: ...
    ...
    def get_preview_properties(self) -> list[PreviewProperties] | None: ...
    # override
    ...
    @staticmethod
    def get_tag_description(tag: str) -> str | None: ...
    def get_tag_interpreted_string(self, tag: str) -> str | None: ...
    @staticmethod
    def get_tag_label(tag: str) -> str | None: ...
    def get_tag_long(self, tag: str) -> int: ...
    def get_tag_multiple(self, tag: str) -> list[str] | None: ...
    def get_tag_raw(self, tag: str) -> GLib.Bytes | None: ...
    def get_tag_string(self, tag: str) -> str | None: ...
    @staticmethod
    ...
    def get_xmp_packet(self) -> str | None: ...
    ...
    def open_buf(self, data: Sequence[int]) -> bool: ...
    # override
    ...
    def set_exif_thumbnail_from_buffer(self, buffer: Sequence[int]) -> None: ...
    ...
    def set_tag_multiple(self, tag: str, values: Sequence[str]) -> bool: ...
    ...
    def try_get_comment(self) -> str | None: ...
    def try_get_exif_tag_rational(self, tag: str) -> tuple[bool, int, int]: ...
    def try_get_exposure_time(self) -> tuple[bool, int, int]: ...
    def try_get_fnumber(self) -> float: ...
    def try_get_focal_length(self) -> float: ...
    def try_get_gps_altitude(self) -> tuple[bool, float]: ...
    def try_get_gps_info(self) -> tuple[bool, float, float, float]: ...
    def try_get_gps_latitude(self) -> tuple[bool, float]: ...
    def try_get_gps_longitude(self) -> tuple[bool, float]: ...
    ...
    @staticmethod
    def try_get_tag_description(tag: str) -> str | None: ...
    def try_get_tag_interpreted_string(self, tag: str) -> str | None: ...
    @staticmethod
    def try_get_tag_label(tag: str) -> str | None: ...
    def try_get_tag_long(self, tag: str) -> int: ...
    def try_get_tag_multiple(self, tag: str) -> list[str] | None: ...
    def try_get_tag_raw(self, tag: str) -> GLib.Bytes | None: ...
    def try_get_tag_string(self, tag: str) -> str | None: ...
    @staticmethod
    def try_get_tag_type(tag: str) -> str | None: ...
    @staticmethod
    def try_get_xmp_namespace_for_tag(tag: str) -> str: ...
    def try_get_xmp_packet(self) -> str | None: ...
    ...
    def try_set_exif_thumbnail_from_buffer(self, buffer: Sequence[int]) -> None: ...
    ...
    def try_set_tag_multiple(self, tag: str, values: Sequence[str]) -> bool: ...
...
class PreviewImage(GObject.Object):
    ...
    def parent_instance(self) -> GObject.Object: ...
    @property
    def priv(self) -> PreviewImagePrivate: ...
    def free(self) -> None: ...
...
class PreviewProperties(GObject.Object):
    ...
    def parent_instance(self) -> GObject.Object: ...
    @property
    def priv(self) -> PreviewPropertiesPrivate: ...
    def get_extension(self) -> str: ...
    def get_height(self) -> int: ...
    def get_mime_type(self) -> str: ...
