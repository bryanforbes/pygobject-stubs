...
# override
ContentDeserializeFunc: TypeAlias = Callable[
    [ContentDeserializer, Unpack[_DataTs]], None
]
# override
ContentSerializeFunc: TypeAlias = Callable[[ContentSerializer, Unpack[_DataTs]], None]
# override
CursorGetTextureCallback: TypeAlias = Callable[
    [Cursor, int, float, Unpack[_DataTs]], tuple[Texture | None, int, int, int, int]
]
...
def content_register_deserializer(
    mime_type: str,
    type: type[Any],
    deserialize: ContentDeserializeFunc[Unpack[_DataTs]],
    *data: Unpack[_DataTs],
) -> None: ...
def content_register_serializer(
    type: type[Any],
    mime_type: str,
    serialize: ContentSerializeFunc[Unpack[_DataTs]],
    *data: Unpack[_DataTs],
) -> None: ...
...
class CicpParamsClass(_gi.Struct): ...
...
class Clipboard(GObject.Object):
    ...
    ) -> tuple[Gio.InputStream | None, str]: ...
    def read_text_async(
        self,
        cancellable: Gio.Cancellable | None = ...,
        callback: Gio.AsyncReadyCallback[Unpack[_DataTs]] | None = ...,
...
class ContentDeserializer(GObject.Object, Gio.AsyncResult):
    ...
    def set_task_data(
        self, data: int | Any | None, notify: GLib.DestroyNotify
    ) -> None: ...
...
class ContentFormats(GObject.GBoxed):
    ...
    """
    def __init__(self, mime_types: Sequence[str] | None = ...) -> None: ...
    # override
    ...
    @classmethod
    def new(cls, mime_types: Sequence[str] | None = ...) -> ContentFormats: ...
    # override
    @classmethod
...
class ContentProvider(GObject.Object):
    ...
    @classmethod
    def new_union(
        cls, providers: Sequence[ContentProvider] | None = ...
    ) -> ContentProvider: ...
...
class ContentProviderClass(_gi.Struct):
    """
    :Constructors:
    ...
    def write_mime_type_async(
        ...
        [
            ...
            Gio.AsyncReadyCallback[Unpack[_DataTs]] | None,
            Unpack[_DataTs],
        ],
        None,
    ]: ...
...
class Cursor(GObject.Object):
    ...
    def new_from_callback(
        cls,
        callback: CursorGetTextureCallback[Unpack[_DataTs]],
        fallback: Cursor | None = ...,
        *data: Unpack[_DataTs],
    ) -> Cursor | None: ...
    @classmethod
    def new_from_name(
        cls, name: str, fallback: Cursor | None = ...
    ) -> Cursor | None: ...
    @classmethod
...
class DmabufTextureBuilder(GObject.Object):
    ...
    def build(
        self, destroy: GLib.DestroyNotify | None = ..., data: int | Any | None = ...
    ) -> Texture | None: ...
...
class DmabufTextureBuilderClass(_gi.Struct): ...
class DmabufTextureClass(_gi.Struct): ...
...
class DragSurfaceInterface(_gi.Struct): ...

class DragSurfaceSize(_gi.Struct):
...
class GLTextureBuilder(GObject.Object):
    ...
    def get_height(self) -> int: ...
    def get_id(self) -> int: ...
    def get_sync(self) -> int | Any | None: ...
    def get_update_region(self) -> cairo.Region | None: ...
    def get_update_texture(self) -> Texture | None: ...
    def get_width(self) -> int: ...
    @classmethod
    ...
    def set_sync(self, sync: int | Any | None = ...) -> None: ...
    def set_update_region(self, region: cairo.Region | None = ...) -> None: ...
    def set_update_texture(self, texture: Texture | None = ...) -> None: ...
    def set_width(self, width: int) -> None: ...

class GLTextureBuilderClass(_gi.Struct): ...
class GLTextureClass(_gi.Struct): ...
...
class MemoryTextureBuilder(GObject.Object):
    ...
    def set_bytes(self, bytes: GLib.Bytes | None = ...) -> None: ...
    def set_color_state(self, color_state: ColorState) -> None: ...
    def set_format(self, format: MemoryFormat) -> None: ...
    def set_height(self, height: int) -> None: ...
    def set_offset(self, plane: int, offset: int) -> None: ...
...
class MemoryTextureBuilderClass(_gi.Struct): ...
class MemoryTextureClass(_gi.Struct): ...
...
class PaintableInterface(_gi.Struct):
    """
    :Constructors:
...
class PopupInterface(_gi.Struct): ...
...
class PopupLayout(GObject.GBoxed):
    ...
    """
    def __init__(
        self, anchor_rect: Rectangle, rect_anchor: Gravity, surface_anchor: Gravity
    ) -> None: ...
...
class Surface(GObject.Object):
    ...
    def translate_coordinates(
        self, to: Surface, x: float, y: float
    ) -> tuple[bool, float, float]: ...

class SurfaceClass(_gi.Struct): ...
...
class ToplevelInterface(_gi.Struct): ...
...
class ToplevelLayout(GObject.GBoxed):
    ...
    def set_fullscreen(
        self, fullscreen: bool, monitor: Monitor | None = ...
    ) -> None: ...
    def set_maximized(self, maximized: bool) -> None: ...
    def set_resizable(self, resizable: bool) -> None: ...
    def unref(self) -> None: ...

class ToplevelSize(_gi.Struct):
