...
def type_tag_argument_from_hash_pointer(
    storage_type: TypeTag, hash_pointer: int | Any | None = ...
) -> Argument: ...
...
class BaseInfoStack(_gi.Struct):
    ...
    def dummy0(self) -> int: ...
    @property
    def dummy1(self) -> list[int | Any | None]: ...
    @property
    def dummy2(self) -> list[int]: ...
    @property
    def dummy3(self) -> list[int | Any | None]: ...
...
class TypeInfo(BaseInfo):
    ...
    def argument_from_hash_pointer(
        self, hash_pointer: int | Any | None = ...
    ) -> Argument: ...
    ...
    def hash_pointer_from_argument(self, arg: Argument) -> int | Any | None: ...
...
class VFuncInfo(CallableInfo):
    ...
    """
    def get_address(self, implementor_gtype: type[Any]) -> int | Any | None: ...
