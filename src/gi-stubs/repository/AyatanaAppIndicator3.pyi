...
class Indicator(GObject.Object):
    ...
    ::
        ...
        new(id:str, icon_name:str, category:AyatanaAppIndicator3.IndicatorCategory) -> AyatanaAppIndicator3.Indicator
        new_with_path(id:str, icon_name:str, category:AyatanaAppIndicator3.IndicatorCategory, icon_theme_path:str) -> AyatanaAppIndicator3.Indicator
    ...
    def do_scroll_event(
        self, delta: int, direction: _Gdk3.ScrollDirection, *user_data: Any
    ) -> None: ...
    def do_unfallback(self, status_icon: _Gtk3.StatusIcon) -> None: ...
    ...
    def get_menu(self) -> _Gtk3.Menu: ...
    def get_ordering_index(self) -> int: ...
    def get_secondary_activate_target(self) -> _Gtk3.Widget: ...
    ...
    def set_menu(self, menu: _Gtk3.Menu | None = None) -> None: ...
    def set_ordering_index(self, ordering_index: int) -> None: ...
    def set_secondary_activate_target(
        self, menuitem: _Gtk3.Widget | None = None
    ) -> None: ...
