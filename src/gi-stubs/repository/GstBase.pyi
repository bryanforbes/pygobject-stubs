...
CollectDataDestroyNotify: TypeAlias = Callable[[CollectData], None]
CollectPadsBufferFunction: TypeAlias = Callable[
    [CollectPads, CollectData, Gst.Buffer, Unpack[_DataTs]], Gst.FlowReturn
]
CollectPadsClipFunction: TypeAlias = Callable[
    [CollectPads, CollectData, Gst.Buffer, Unpack[_DataTs]],
    tuple[Gst.FlowReturn, Gst.Buffer],
]
CollectPadsCompareFunction: TypeAlias = Callable[
    [CollectPads, CollectData, int, CollectData, int, Unpack[_DataTs]], int
]
CollectPadsEventFunction: TypeAlias = Callable[
    [CollectPads, CollectData, Gst.Event, Unpack[_DataTs]], bool
]
CollectPadsFlushFunction: TypeAlias = Callable[[CollectPads, Unpack[_DataTs]], None]
CollectPadsFunction: TypeAlias = Callable[
    [CollectPads, Unpack[_DataTs]], Gst.FlowReturn
]
CollectPadsQueryFunction: TypeAlias = Callable[
    [CollectPads, CollectData, Gst.Query, Unpack[_DataTs]], bool
]
DataQueueEmptyCallback: TypeAlias = Callable[[DataQueue, Any], None]
DataQueueFullCallback: TypeAlias = Callable[[DataQueue, Any], None]
TypeFindHelperGetRangeFunction: TypeAlias = Callable[
...
def type_find_helper_for_buffer_with_extension(
    obj: Gst.Object | None, buf: Gst.Buffer, extension: str | None = ...
) -> tuple[Gst.Caps | None, Gst.TypeFindProbability]: ...
...
def type_find_helper_for_data_with_extension(
    obj: Gst.Object | None, data: Sequence[int], extension: str | None = ...
) -> tuple[Gst.Caps | None, Gst.TypeFindProbability]: ...
...
class Aggregator(Gst.Element):
    ...
    def do_create_new_pad(
        self, templ: Gst.PadTemplate, req_name: str | None, caps: Gst.Caps | None
    ) -> AggregatorPad: ...
    ...
    def selected_samples(
        self, pts: int, dts: int, duration: int, info: Gst.Structure | None = ...
    ) -> None: ...
...
class AggregatorClass(_gi.Struct):
    ...
    def update_src_caps(
        self,
    ) -> Callable[[Aggregator, Gst.Caps], tuple[Gst.FlowReturn, Gst.Caps | None]]: ...
    @property
...
class BaseSink(Gst.Element):
    ...
    def segment(self) -> Gst.Segment: ...
    @property
    def clock_id(self) -> int | Any | None: ...
    @property
    def sync(self) -> bool: ...
    @property
...
class BaseSrc(Gst.Element):
    ...
    def do_create(
        self, offset: int, size: int, buf: Gst.Buffer | None
    ) -> tuple[Gst.FlowReturn, Gst.Buffer | None]: ...
    def do_decide_allocation(self, query: Gst.Query) -> bool: ...
...
class BaseSrcClass(_gi.Struct):
    ...
    def create(
        ...
        [BaseSrc, int, int, Gst.Buffer | None], tuple[Gst.FlowReturn, Gst.Buffer | None]
    ]: ...
    @property
    def alloc(
        self,
    ) -> Callable[[BaseSrc, int, int], tuple[Gst.FlowReturn, Gst.Buffer | None]]: ...
    @property
...
class CollectPads(Gst.Object):
    ...
    def clip_running_time(
        self, cdata: CollectData, buf: Gst.Buffer, user_data: int | Any | None = ...
    ) -> tuple[Gst.FlowReturn, Gst.Buffer]: ...
    def event_default(
    ...
    def set_buffer_function(
        self,
        func: CollectPadsBufferFunction[Unpack[_DataTs]],
        *user_data: Unpack[_DataTs],
    ) -> None: ...
    def set_clip_function(
        self,
        clipfunc: CollectPadsClipFunction[Unpack[_DataTs]],
        *user_data: Unpack[_DataTs],
    ) -> None: ...
    def set_compare_function(
        self,
        func: CollectPadsCompareFunction[Unpack[_DataTs]],
        *user_data: Unpack[_DataTs],
    ) -> None: ...
    def set_event_function(
        self,
        func: CollectPadsEventFunction[Unpack[_DataTs]],
        *user_data: Unpack[_DataTs],
    ) -> None: ...
    def set_flush_function(
        self,
        func: CollectPadsFlushFunction[Unpack[_DataTs]],
        *user_data: Unpack[_DataTs],
    ) -> None: ...
    def set_flushing(self, flushing: bool) -> None: ...
    def set_function(
        self, func: CollectPadsFunction[Unpack[_DataTs]], *user_data: Unpack[_DataTs]
    ) -> None: ...
    def set_query_function(
        self,
        func: CollectPadsQueryFunction[Unpack[_DataTs]],
        *user_data: Unpack[_DataTs],
    ) -> None: ...
...
class PushSrc(BaseSrc):
    ...
    def do_alloc(self) -> tuple[Gst.FlowReturn, Gst.Buffer | None]: ...
    def do_create(
        self, buf: Gst.Buffer | None
    ) -> tuple[Gst.FlowReturn, Gst.Buffer | None]: ...
...
class PushSrcClass(_gi.Struct):
    ...
    def create(
        ...
        [PushSrc, Gst.Buffer | None], tuple[Gst.FlowReturn, Gst.Buffer | None]
    ]: ...
    @property
    def alloc(
        self,
    ) -> Callable[[PushSrc], tuple[Gst.FlowReturn, Gst.Buffer | None]]: ...
    @property
