...
AppSinkEosCallback: TypeAlias = Callable[[AppSink, Unpack[_DataTs]], None]
AppSinkNewEventCallback: TypeAlias = Callable[[AppSink, Unpack[_DataTs]], bool]
AppSinkNewPrerollCallback: TypeAlias = Callable[
    [AppSink, Unpack[_DataTs]], Gst.FlowReturn
]
AppSinkNewSampleCallback: TypeAlias = Callable[
    [AppSink, Unpack[_DataTs]], Gst.FlowReturn
]
AppSinkProposeAllocationCallback: TypeAlias = Callable[
    [AppSink, Gst.Query, Unpack[_DataTs]], bool
]
AppSrcEnoughDataCallback: TypeAlias = Callable[[AppSrc, Unpack[_DataTs]], None]
AppSrcNeedDataCallback: TypeAlias = Callable[[AppSrc, int, Unpack[_DataTs]], None]
AppSrcSeekDataCallback: TypeAlias = Callable[[AppSrc, int, Unpack[_DataTs]], bool]
...
class AppSinkSimpleCallbacks(GObject.GBoxed):
    ...
    def set_eos(
        self, eos_cb: AppSinkEosCallback[Unpack[_DataTs]], *user_data: Unpack[_DataTs]
    ) -> None: ...
    def set_new_event(
        self,
        new_event_cb: AppSinkNewEventCallback[Unpack[_DataTs]],
        *user_data: Unpack[_DataTs],
    ) -> None: ...
    def set_new_preroll(
        self,
        new_preroll_cb: AppSinkNewPrerollCallback[Unpack[_DataTs]],
        *user_data: Unpack[_DataTs],
    ) -> None: ...
    def set_new_sample(
        self,
        new_sample_cb: AppSinkNewSampleCallback[Unpack[_DataTs]],
        *user_data: Unpack[_DataTs],
    ) -> None: ...
    def set_propose_allocation(
        self,
        propose_allocation_cb: AppSinkProposeAllocationCallback[Unpack[_DataTs]],
        *user_data: Unpack[_DataTs],
    ) -> None: ...
    def unref(self) -> None: ...
...
class AppSrcSimpleCallbacks(GObject.GBoxed):
    ...
    def set_enough_data(
        self,
        enough_data_cb: AppSrcEnoughDataCallback[Unpack[_DataTs]],
        *user_data: Unpack[_DataTs],
    ) -> None: ...
    def set_need_data(
        self,
        need_data_cb: AppSrcNeedDataCallback[Unpack[_DataTs]],
        *user_data: Unpack[_DataTs],
    ) -> None: ...
    def set_seek_data(
        self,
        seek_data_cb: AppSrcSeekDataCallback[Unpack[_DataTs]],
        *user_data: Unpack[_DataTs],
    ) -> None: ...
    def unref(self) -> None: ...
