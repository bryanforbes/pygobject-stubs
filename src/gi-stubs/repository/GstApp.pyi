...
class AppSinkClass(GObject.GPointer):
    ...
    eos: Callable[[AppSink], None] = ...
    new_preroll: Callable[[AppSink], Gst.FlowReturn] = ...
    new_sample: Callable[[AppSink], Gst.FlowReturn] = ...
    pull_preroll: Callable[[AppSink], Gst.Sample | None] = ...
    pull_sample: Callable[[AppSink], Gst.Sample | None] = ...
    try_pull_preroll: Callable[[AppSink, int], Gst.Sample | None] = ...
    try_pull_sample: Callable[[AppSink, int], Gst.Sample | None] = ...
    try_pull_object: Callable[[AppSink, int], Gst.MiniObject | None] = ...
...
class AppSrcClass(GObject.GPointer):
    ...
    need_data: Callable[[AppSrc, int], None] = ...
    enough_data: Callable[[AppSrc], None] = ...
    seek_data: Callable[[AppSrc, int], bool] = ...
    push_buffer: Callable[[AppSrc, Gst.Buffer], Gst.FlowReturn] = ...
    end_of_stream: Callable[[AppSrc], Gst.FlowReturn] = ...
    push_sample: Callable[[AppSrc, Gst.Sample], Gst.FlowReturn] = ...
    push_buffer_list: Callable[[AppSrc, Gst.BufferList], Gst.FlowReturn] = ...
