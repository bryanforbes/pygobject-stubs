...
AudioVisualizerShaderFunc: TypeAlias = Callable[
    [AudioVisualizer, GstVideo.VideoFrame, GstVideo.VideoFrame], None
]
InstallPluginsResultFunc: TypeAlias = Callable[
    [InstallPluginsReturn, Unpack[_DataTs]], None
]
...
def codec_utils_opus_create_caps_from_header(
    header: Gst.Buffer, comments: Gst.Buffer | None = ...
) -> Gst.Caps | None: ...
...
def install_plugins_async(
    ...
    func: InstallPluginsResultFunc[Unpack[_DataTs]],
...
def install_plugins_sync(
    details: Sequence[str], ctx: InstallPluginsContext | None = ...
) -> InstallPluginsReturn: ...
...
class AudioVisualizerClass(_gi.Struct):
    """
    :Constructors:
...
class AudioVisualizerPrivate(_gi.Struct): ...
...
class DiscovererClass(_gi.Struct):
    """
    :Constructors:
...
class EncodingAudioProfileClass(_gi.Struct): ...
...
class EncodingContainerProfileClass(_gi.Struct): ...
...
class EncodingProfile(GObject.Object):
    ...
    @staticmethod
    def find(
        targetname: str, profilename: str | None = ..., category: str | None = ...
    ...
    def set_preset_name(self, preset_name: str | None = ...) -> None: ...
    def set_restriction(self, restriction: Gst.Caps | None = ...) -> None: ...
    def set_single_segment(self, single_segment: bool) -> None: ...
    def to_string(self) -> str: ...

class EncodingProfileClass(_gi.Struct): ...
...
class EncodingTarget(GObject.Object):
    ...
    def get_profiles(self) -> list[EncodingProfile]: ...
    @staticmethod
    def load(name: str, category: str | None = ...) -> EncodingTarget: ...
    @staticmethod
...
class EncodingVideoProfileClass(_gi.Struct): ...
