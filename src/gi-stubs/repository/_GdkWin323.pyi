...
def win32_selection_clear_targets_libgtk_only(
    display: _Gdk3.Display, selection: _Gdk3.Atom
) -> None: ...

class Win32Cursor(_Gdk3.Cursor): ...
class Win32CursorClass(GObject.GPointer): ...

class Win32Display(_Gdk3.Display):
    """
    :Constructors:
...
class Win32Monitor(_Gdk3.Monitor): ...
class Win32MonitorClass(GObject.GPointer): ...
class Win32Screen(_Gdk3.Screen): ...
class Win32ScreenClass(GObject.GPointer): ...

class Win32Window(_Gdk3.Window):
    """
    :Constructors:
    ...
    @staticmethod
    def is_win32(window: _Gdk3.Window) -> bool: ...
