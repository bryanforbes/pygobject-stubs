...
SizeFunc: TypeAlias = Callable[[Unpack[_DataTs]], tuple[int, int]]
...
class Handle(GObject.Object):
    ...
    def get_position_sub(self, id: str | None = ...) -> tuple[bool, PositionData]: ...
    ...
    def read_stream_sync(
        self, stream: Gio.InputStream, cancellable: Gio.Cancellable | None = ...
    ) -> bool: ...
    def render_cairo(self, cr: cairo.Context[_SomeSurface]) -> bool: ...
    def render_cairo_sub(
        self, cr: cairo.Context[_SomeSurface], id: str | None = ...
    ) -> bool: ...
    def render_document(
    ...
    def set_size_callback(
        self,
        size_func: SizeFunc[Unpack[_DataTs]] | None = ...,
