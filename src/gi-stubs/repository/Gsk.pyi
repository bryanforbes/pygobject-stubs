...
ParseErrorFunc: TypeAlias = Callable[
    [ParseLocation, ParseLocation, GLib.GError, Unpack[_DataTs]], None
]
PathForeachFunc: TypeAlias = Callable[
    [PathOperation, list[Graphene.Point], float, Unpack[_DataTs]], bool
]
PathIntersectionFunc: TypeAlias = Callable[
...
def stroke_equal(
    stroke1: int | Any | None = ..., stroke2: int | Any | None = ...
) -> bool: ...
...
def value_take_render_node(value: Any, node: RenderNode | None = ...) -> None: ...
...
class GLShaderNode(RenderNode):
    ...
    def new(
        ...
        bounds: Graphene.Rect,
        args: GLib.Bytes,
        children: Sequence[RenderNode] | None = ...,
    ) -> GLShaderNode: ...
...
class Path(GObject.GBoxed):
    def foreach(
        ...
        func: PathForeachFunc[Unpack[_DataTs]],
        *user_data: Unpack[_DataTs],
    ) -> bool: ...
    def foreach_intersection(
        self,
        path2: Path | None,
        func: PathIntersectionFunc[Unpack[_DataTs]],
        *user_data: Unpack[_DataTs],
    ) -> bool: ...
...
class RenderNode(_gi.Fundamental):
    ...
    def deserialize(
        bytes: GLib.Bytes,
        error_func: ParseErrorFunc[Unpack[_DataTs]] | None = ...,
        *user_data: Unpack[_DataTs],
    ) -> RenderNode | None: ...
...
class RepeatNode(RenderNode):
    ...
    def new(
        ...
        bounds: Graphene.Rect,
        child: RenderNode,
        child_bounds: Graphene.Rect | None = ...,
    ) -> RepeatNode: ...
...
class ShaderArgsBuilder(GObject.GBoxed):
    ...
    """
    def __init__(
        self, shader: GLShader, initial_values: GLib.Bytes | None = ...
    ) -> None: ...
    @classmethod
    def new(
        cls, shader: GLShader, initial_values: GLib.Bytes | None = ...
    ) -> ShaderArgsBuilder: ...
...
class Stroke(GObject.GBoxed):
    ...
    def set_dash(self, dash: Sequence[float] | None = ...) -> None: ...
